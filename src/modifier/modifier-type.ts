...
import {
  ...
  getVoucherTypeName,
  VoucherType,
} from "#app/system/voucher";
import type {
  PokemonMoveSelectFilter,
  PokemonSelectFilter,
} from "#app/ui/party-ui-handler";
  ...
  getOrInferTier(
    ...
    for (const type of poolTypes) {
      ...
      for (const tier of getEnumValues(ModifierTier)) {
        ...
        if (
          pool[tier].find(
            (m) => (m as WeightedModifierType).modifierType.id === this.id,
          )
        ) {
...
type ModifierTypeGeneratorFunc = (
  party: Pokemon[],
  pregenArgs?: any[],
) => ModifierType | null;
...
class AddPokeballModifierType extends ModifierType {
  ...
  constructor(iconImage: string, pokeballType: PokeballType, count: number) {
    super(
      "",
      iconImage,
      (_type, _args) => new AddPokeballModifier(this, pokeballType, count),
      "pb",
      "se/pb_bounce_1",
    );
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.AddPokeballModifierType.description",
      {
        modifierCount: this.count,
        pokeballName: getPokeballName(this.pokeballType),
        catchRate:
...
class AddVoucherModifierType extends ModifierType {
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.AddVoucherModifierType.description",
      {
        modifierCount: this.count,
        voucherTypeName: getVoucherTypeName(this.voucherType),
      },
  ...
  constructor(
    ...
    super(
      ...
      (pokemon: PlayerPokemon) => {
        ...
        if (!maxStackCount) {
          return i18next.t(
            "modifierType:ModifierType.PokemonHeldItemModifierType.extra.inoperable",
            {
        ...
        if (matchingModifier && matchingModifier.stackCount === maxStackCount) {
          return i18next.t(
            "modifierType:ModifierType.PokemonHeldItemModifierType.extra.tooMany",
            {
              pokemonName: getPokemonNameWithAffix(pokemon),
            },
          );
...
export class TerastallizeModifierType extends PokemonModifierType {
  ...
  constructor(teraType: PokemonType) {
    super(
      ...
      (type, args) =>
        new TerrastalizeModifier(
          type as TerastallizeModifierType,
  ...
  get name(): string {
    return i18next.t(
      "modifierType:ModifierType.TerastallizeModifierType.name",
      {
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.TerastallizeModifierType.description",
      {
        teraType: i18next.t(`pokemonInfo:Type.${PokemonType[this.teraType]}`),
      },
    );
...
export class PokemonHpRestoreModifierType extends PokemonModifierType {
  ...
  getDescription(): string {
    return this.restorePoints
      ? i18next.t(
          "modifierType:ModifierType.PokemonHpRestoreModifierType.description",
          {
      ...
      : this.healStatus
        ? i18next.t(
            "modifierType:ModifierType.PokemonHpRestoreModifierType.extra.fullyWithStatus",
          )
        : i18next.t(
            "modifierType:ModifierType.PokemonHpRestoreModifierType.extra.fully",
          );
  }
}
...
export class PokemonReviveModifierType extends PokemonHpRestoreModifierType {
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonReviveModifierType.description",
      {
        restorePercent: this.restorePercent,
      },
    );
...
export class PokemonStatusHealModifierType extends PokemonModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new PokemonStatusHealModifier(this, (args[0] as PlayerPokemon).id),
      (pokemon: PlayerPokemon) => {
        if (
          !pokemon.hp ||
          (!pokemon.status && !pokemon.getTag(BattlerTagType.CONFUSED))
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonStatusHealModifierType.description",
    );
  }
}
...
export class PokemonPpRestoreModifierType extends PokemonMoveModifierType {
  ...
  getDescription(): string {
    return this.restorePoints > -1
      ? i18next.t(
          "modifierType:ModifierType.PokemonPpRestoreModifierType.description",
          {
            restorePoints: this.restorePoints,
          },
        )
      : i18next.t(
          "modifierType:ModifierType.PokemonPpRestoreModifierType.extra.fully",
        );
  }
}
...
export class PokemonAllMovePpRestoreModifierType extends PokemonModifierType {
  ...
  constructor(localeKey: string, iconImage: string, restorePoints: number) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new PokemonAllMovePpRestoreModifier(
          this,
          (args[0] as PlayerPokemon).id,
          this.restorePoints,
        ),
  ...
  getDescription(): string {
    return this.restorePoints > -1
      ? i18next.t(
          "modifierType:ModifierType.PokemonAllMovePpRestoreModifierType.description",
          {
            restorePoints: this.restorePoints,
          },
        )
      : i18next.t(
          "modifierType:ModifierType.PokemonAllMovePpRestoreModifierType.extra.fully",
        );
  }
}
...
export class PokemonPpUpModifierType extends PokemonMoveModifierType {
  ...
  constructor(localeKey: string, iconImage: string, upPoints: number) {
    super(
      ...
      (pokemonMove: PokemonMove) => {
        if (
          pokemonMove.getMove().pp < 5 ||
          pokemonMove.ppUp >= 3 ||
          pokemonMove.maxPpOverride
        ) {
          return PartyUiHandler.NoEffectMessage;
        }
        return null;
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonPpUpModifierType.description",
...
export class PokemonNatureChangeModifierType extends PokemonModifierType {
  ...
  constructor(nature: Nature) {
    super(
      ...
      (_type, args) =>
        new PokemonNatureChangeModifier(
          this,
          (args[0] as PlayerPokemon).id,
          this.nature,
        ),
  ...
  get name(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonNatureChangeModifierType.name",
      {
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonNatureChangeModifierType.description",
      {
...
export class DoubleBattleChanceBoosterModifierType extends ModifierType {
  ...
  constructor(localeKey: string, iconImage: string, maxBattles: number) {
    super(
      localeKey,
      iconImage,
      (_type, _args) => new DoubleBattleChanceBoosterModifier(this, maxBattles),
      "lure",
    );
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.DoubleBattleChanceBoosterModifierType.description",
      {
...
export class TempStatStageBoosterModifierType
  ...
  implements GeneratedPersistentModifierType
{
  ...
  constructor(stat: TempBattleStat) {
    ...
    super(
      "",
      nameKey,
      (_type, _args) => new TempStatStageBoosterModifier(this, this.stat, 5),
    );
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.TempStatStageBoosterModifierType.description",
      {
        stat: i18next.t(getStatKey(this.stat)),
        amount: i18next.t(
          `modifierType:ModifierType.TempStatStageBoosterModifierType.extra.${this.quantityKey}`,
        ),
      },
    );
  }
...
export class BerryModifierType
  ...
  implements GeneratedPersistentModifierType
{
  ...
  constructor(berryType: BerryType) {
    super(
      ...
      (type, args) =>
        new BerryModifier(type, (args[0] as Pokemon).id, berryType),
      "berry",
    );
  ...
  implements GeneratedPersistentModifierType
{
  ...
  get name(): string {
    return i18next.t(
      `modifierType:AttackTypeBoosterItem.${AttackTypeBoosterItem[this.moveType]?.toLowerCase()}`,
    );
  }
  ...
  getDescription(): string {
    ...
    return i18next.t(
      "modifierType:ModifierType.AttackTypeBoosterModifierType.description",
      {
...
export type SpeciesStatBoosterItem =
  keyof typeof SpeciesStatBoosterModifierTypeGenerator.items;
  ...
  implements GeneratedPersistentModifierType
{
  ...
  constructor(key: SpeciesStatBoosterItem) {
    ...
    super(
      ...
      key.toLowerCase(),
      (type, args) =>
        new SpeciesStatBoosterModifier(
          type,
          (args[0] as Pokemon).id,
          item.stats,
          item.multiplier,
...
export class PokemonLevelIncrementModifierType extends PokemonModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new PokemonLevelIncrementModifier(this, (args[0] as PlayerPokemon).id),
  ...
  getDescription(): string {
    let levels = 1;
    const hasCandyJar = globalScene.modifiers.find(
      (modifier) => modifier instanceof LevelIncrementBoosterModifier,
    );
    if (hasCandyJar) {
      levels += hasCandyJar.stackCount;
    }
    return i18next.t(
      "modifierType:ModifierType.PokemonLevelIncrementModifierType.description",
      { levels },
    );
  }
}
...
export class AllPokemonLevelIncrementModifierType extends ModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      localeKey,
      iconImage,
      (_type, _args) => new PokemonLevelIncrementModifier(this, -1),
    );
  }
  ...
  getDescription(): string {
    ...
    return i18next.t(
      "modifierType:ModifierType.AllPokemonLevelIncrementModifierType.description",
      { levels },
    );
  }
}
  ...
  implements GeneratedPersistentModifierType
{
  ...
  constructor(stat: PermanentStat) {
    ...
    super(
      ...
      key,
      (_type, args) =>
        new BaseStatModifier(this, (args[0] as Pokemon).id, this.stat),
    );
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.BaseStatBoosterModifierType.description",
      {
        stat: i18next.t(getStatKey(this.stat)),
      },
    );
  ...
  implements GeneratedPersistentModifierType
{
  ...
  constructor(statModifier: number) {
    super(
      ...
      "berry_juice",
      (_type, args) =>
        new PokemonBaseStatTotalModifier(
          this,
          (args[0] as Pokemon).id,
          this.statModifier,
        ),
  ...
  override getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonBaseStatTotalModifierType.description",
      {
  ...
  implements GeneratedPersistentModifierType
{
  ...
  constructor(statModifier: number, stats: Stat[]) {
    super(
      ...
      "old_gateau",
      (_type, args) =>
        new PokemonBaseStatFlatModifier(
          this,
          (args[0] as Pokemon).id,
          this.statModifier,
          this.stats,
  ...
  override getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonBaseStatFlatModifierType.description",
      {
...
class AllPokemonFullHpRestoreModifierType extends ModifierType {
  ...
  constructor(
    ...
    super(
      ...
      newModifierFunc ||
        ((_type, _args) =>
          new PokemonHpRestoreModifier(this, -1, 0, 100, false)),
    );
...
class AllPokemonFullReviveModifierType extends AllPokemonFullHpRestoreModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      (_type, _args) =>
        new PokemonHpRestoreModifier(this, -1, 0, 100, false, true),
    );
  }
}
...
export class MoneyRewardModifierType extends ModifierType {
  ...
  constructor(
    ...
    super(
      localeKey,
      iconImage,
      (_type, _args) => new MoneyRewardModifier(this, moneyMultiplier),
      "money",
      "se/buy",
    );
  ...
  getDescription(): string {
    const moneyAmount = new NumberHolder(
      globalScene.getWaveMoneyAmount(this.moneyMultiplier),
    );
    globalScene.applyModifiers(MoneyMultiplierModifier, true, moneyAmount);
    const formattedMoney = formatMoney(
      globalScene.moneyFormat,
      moneyAmount.value,
    );

    return i18next.t(
      "modifierType:ModifierType.MoneyRewardModifierType.description",
      {
...
export class PokemonExpBoosterModifierType extends PokemonHeldItemModifierType {
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonExpBoosterModifierType.description",
      {
        boostPercent: this.boostPercent,
      },
    );
...
export class PokemonFriendshipBoosterModifierType extends PokemonHeldItemModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new PokemonFriendshipBoosterModifier(this, (args[0] as Pokemon).id),
    );
  }

  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonFriendshipBoosterModifierType.description",
    );
  }
}
...
export class PokemonMoveAccuracyBoosterModifierType extends PokemonHeldItemModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      (_type, args) =>
        new PokemonMoveAccuracyBoosterModifier(
          this,
          (args[0] as Pokemon).id,
          amount,
        ),
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonMoveAccuracyBoosterModifierType.description",
      {
...
export class PokemonMultiHitModifierType extends PokemonHeldItemModifierType {
    ...
    super(
      ...
      (type, args) =>
        new PokemonMultiHitModifier(
          type as PokemonMultiHitModifierType,
          (args[0] as Pokemon).id,
        ),
    );
  }
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.PokemonMultiHitModifierType.description",
    );
  }
}
...
export class TmModifierType extends PokemonModifierType {
  ...
  get name(): string {
    return i18next.t("modifierType:ModifierType.TmModifierType.name", {
      moveId: padInt(
        Object.keys(tmSpecies).indexOf(this.moveId.toString()) + 1,
        3,
      ),
...
export class EvolutionItemModifierType
  extends PokemonModifierType
  implements GeneratedPersistentModifierType
{
  ...
  constructor(evolutionItem: EvolutionItem) {
    super(
      ...
      (_type, args) =>
        new EvolutionItemModifier(this, (args[0] as PlayerPokemon).id),
      (pokemon: PlayerPokemon) => {
        if (
        ...
        if (
          ...
          pokemonEvolutions[pokemon.fusionSpecies.speciesId].filter(
            (e) =>
              ...
              (!e.condition || e.condition.predicate(pokemon)) &&
              (e.preFormKey === null ||
                e.preFormKey === pokemon.getFusionFormKey()),
          ).length &&
  ...
  get name(): string {
    return i18next.t(
      `modifierType:EvolutionItem.${EvolutionItem[this.evolutionItem]}`,
    );
  }

  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.EvolutionItemModifierType.description",
    );
  }
 ...
 */
export class FormChangeItemModifierType
  extends PokemonModifierType
  implements GeneratedPersistentModifierType
{
  ...
  constructor(formChangeItem: FormChangeItem) {
    super(
      ...
      (_type, args) =>
        new PokemonFormChangeItemModifier(
          this,
          (args[0] as PlayerPokemon).id,
          formChangeItem,
          true,
          ...
          pokemonFormChanges[pokemon.species.speciesId]
            .filter(
              (fc) =>
                ...
                fc.preFormKey === pokemon.getFormKey(),
            )
            ...
            .flatMap(
              (fc) =>
                fc.findTrigger(
                  SpeciesFormChangeItemTrigger,
                ) as SpeciesFormChangeItemTrigger,
            )
            .flatMap((fc) => fc.item)
  ...
  get name(): string {
    return i18next.t(
      `modifierType:FormChangeItem.${FormChangeItem[this.formChangeItem]}`,
    );
  }

  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.FormChangeItemModifierType.description",
    );
  }
...
export class FusePokemonModifierType extends PokemonModifierType {
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.FusePokemonModifierType.description",
    );
  }
}
  ...
  constructor() {
    super((party: Pokemon[], pregenArgs?: any[]) => {
      if (
        pregenArgs &&
        pregenArgs.length === 1 &&
        pregenArgs[0] in PokemonType
      ) {
        return new AttackTypeBoosterModifierType(
          pregenArgs[0] as PokemonType,
          TYPE_BOOST_ITEM_BOOST_PERCENT,
        );
      }
  ...
  constructor() {
    super((_party: Pokemon[], pregenArgs?: any[]) => {
      if (
        pregenArgs &&
        pregenArgs.length === 1 &&
        TEMP_BATTLE_STATS.includes(pregenArgs[0])
      ) {
  ...
  constructor(rare: boolean) {
    super((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      if (pregenArgs && pregenArgs.length === 1 && pregenArgs[0] in items) {
        return new SpeciesStatBoosterModifierType(
          pregenArgs[0] as SpeciesStatBoosterItem,
        );
      }
      ...
      for (const p of party) {
        ...
        const fusionSpeciesId = p.isFusion()
          ? p.getFusionSpeciesForm(true).speciesId
          : null;
        // TODO: Use commented boolean when Fling is implemented
        const hasFling =
          false; /* p.getMoveset(true).some(m => m.moveId === Moves.FLING) */
          ...
          const hasItem = p
            ...
            .some(
              (m) =>
                ...
                (m as SpeciesStatBoosterModifier).contains(
                  checkedSpecies[0],
                  checkedStats[0],
                ),
            );
        ...
        for (const i in weights) {
          if (weights[i] !== 0) {
            ...
            if (randInt <= weight + weights[i]) {
              return new SpeciesStatBoosterModifierType(
                keys[i] as SpeciesStatBoosterItem,
              );
            }
            weight = curWeight;
          }
    ...
    super((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      const partyMemberCompatibleTms = party.map((p) => {
        ...
        return (p as PlayerPokemon).compatibleTms.filter(
          (tm) =>
            !p.moveset.find((m) => m.moveId === tm) &&
            !previousLevelMoves.find((lm) => lm === tm),
        );
      });
...
class EvolutionItemModifierTypeGenerator extends ModifierTypeGenerator {
  constructor(rare: boolean) {
    super((party: Pokemon[], pregenArgs?: any[]) => {
          ...
          .flatMap((p) => {
            ...
            return evolutions.filter(
              (e) =>
                e.item !== EvolutionItem.NONE &&
                (e.evoFormKey === null ||
                  (e.preFormKey || "") === p.getFusionFormKey()) &&
                (!e.condition || e.condition.predicate(p)),
            );
          }),
      ]
      ...
      return new EvolutionItemModifierType(
        evolutionItemPool[randSeedInt(evolutionItemPool.length)]!,
  ...
  constructor(isRareFormChangeItem: boolean) {
    super((party: Pokemon[], pregenArgs?: any[]) => {
      if (
        pregenArgs &&
        pregenArgs.length === 1 &&
        pregenArgs[0] in FormChangeItem
      ) {
                ...
                .filter(
                  (fc) =>
                    ((fc.formKey.indexOf(SpeciesFormKey.MEGA) === -1 &&
                      ...
                      globalScene.getModifiers(MegaEvolutionAccessModifier)
                        .length) &&
                    ((fc.formKey.indexOf(SpeciesFormKey.GIGANTAMAX) === -1 &&
                      fc.formKey.indexOf(SpeciesFormKey.ETERNAMAX) === -1) ||
                      globalScene.getModifiers(GigantamaxAccessModifier)
                        .length) &&
                    (!fc.conditions.length ||
                      fc.conditions.filter(
                        (cond) =>
                          cond instanceof SpeciesFormChangeCondition &&
                          cond.predicate(p),
                      ).length) &&
      ...
      return new FormChangeItemModifierType(
        formChangeItemPool[randSeedInt(formChangeItemPool.length)],
      );
    });
  }
}
...
export class ContactHeldItemTransferChanceModifierType extends PokemonHeldItemModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      (type, args) =>
        new ContactHeldItemTransferChanceModifier(
          type,
          (args[0] as Pokemon).id,
          chancePercent,
        ),
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.ContactHeldItemTransferChanceModifierType.description",
      {
...
export class TurnHeldItemTransferModifierType extends PokemonHeldItemModifierType {
  constructor(
    ...
    super(
      ...
      iconImage,
      (type, args) =>
        new TurnHeldItemTransferModifier(type, (args[0] as Pokemon).id),
      group,
      soundName,
    );
  }
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.TurnHeldItemTransferModifierType.description",
    );
  }
}
...
export class EnemyAttackStatusEffectChanceModifierType extends ModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      (type, _args) =>
        new EnemyAttackStatusEffectChanceModifier(
          type,
          effect,
          chancePercent,
          stackCount,
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.EnemyAttackStatusEffectChanceModifierType.description",
      {
        chancePercent: this.chancePercent,
...
export class EnemyEndureChanceModifierType extends ModifierType {
  ...
  constructor(localeKey: string, iconImage: string, chancePercent: number) {
    super(
      localeKey,
      iconImage,
      (type, _args) => new EnemyEndureChanceModifier(type, chancePercent),
      "enemy_endure",
    );
  ...
  getDescription(): string {
    return i18next.t(
      "modifierType:ModifierType.EnemyEndureChanceModifierType.description",
      {
        chancePercent: this.chancePercent,
      },
    );
...
type WeightedModifierTypeWeightFunc = (
  party: Pokemon[],
  rerollCount?: number,
) => number;
 ...
 */
function skipInClassicAfterWave(
  wave: number,
  defaultWeight: number,
): WeightedModifierTypeWeightFunc {
  return () => {
 ...
 * @returns A WeightedModifierTypeWeightFunc
 */
function skipInLastClassicWaveOrDefault(
  defaultWeight: number,
): WeightedModifierTypeWeightFunc {
...
function lureWeightFunc(
  ...
  return () => {
    ...
    return !(
      ...
      globalScene.currentBattle.waveIndex === 199
    ) &&
      (lures.length === 0 ||
        lures.filter(
          (m) =>
            m.getMaxBattles() === maxBattles &&
            m.getBattleCount() >= maxBattles * 0.6,
        ).length === 0)
      ? weight
      : 0;
  };
...
class WeightedModifierType {
  ...
  constructor(
    ...
    this.modifierType.id = Object.keys(modifierTypes).find(
...
export type GeneratorModifierOverride = {
  ...
  | {
      name: keyof Pick<
        typeof modifierTypes,
        "ATTACK_TYPE_BOOSTER" | "TERA_SHARD"
      >;
      type?: PokemonType;
    }
  | {
  ...
  | {
      name: keyof Pick<
        typeof modifierTypes,
        "FORM_CHANGE_ITEM" | "RARE_FORM_CHANGE_ITEM"
      >;
      type?: FormChangeItem;
    }
  | {
...
export const modifierTypes = {
  ...
  GREAT_BALL: () =>
    new AddPokeballModifierType("gb", PokeballType.GREAT_BALL, 5),
  ULTRA_BALL: () =>
    new AddPokeballModifierType("ub", PokeballType.ULTRA_BALL, 5),
  ROGUE_BALL: () =>
    new AddPokeballModifierType("rb", PokeballType.ROGUE_BALL, 5),
  MASTER_BALL: () =>
    new AddPokeballModifierType("mb", PokeballType.MASTER_BALL, 1),

  RARE_CANDY: () =>
    new PokemonLevelIncrementModifierType(
      "modifierType:ModifierType.RARE_CANDY",
      "rare_candy",
    ),
  RARER_CANDY: () =>
    new AllPokemonLevelIncrementModifierType(
  ...
  MAP: () =>
    new ModifierType(
      "modifierType:ModifierType.MAP",
      "map",
      (type, _args) => new MapModifier(type),
    ),

  POTION: () =>
    new PokemonHpRestoreModifierType(
  ...
  FULL_HEAL: () =>
    new PokemonStatusHealModifierType(
      "modifierType:ModifierType.FULL_HEAL",
      "full_heal",
    ),

  SACRED_ASH: () =>
    new AllPokemonFullReviveModifierType(
  ...
  REVIVER_SEED: () =>
    new PokemonHeldItemModifierType(
      ...
      "reviver_seed",
      (type, args) =>
        new PokemonInstantReviveModifier(type, (args[0] as Pokemon).id),
    ),
  WHITE_HERB: () =>
    new PokemonHeldItemModifierType(
      ...
      "white_herb",
      (type, args) =>
        new ResetNegativeStatStageModifier(type, (args[0] as Pokemon).id),
    ),

  ETHER: () =>
    new PokemonPpRestoreModifierType(
  ...
  ELIXIR: () =>
    new PokemonAllMovePpRestoreModifierType(
  ...
  PP_UP: () =>
    new PokemonPpUpModifierType("modifierType:ModifierType.PP_UP", "pp_up", 1),
  PP_MAX: () =>
    new PokemonPpUpModifierType(
      "modifierType:ModifierType.PP_MAX",
      "pp_max",
      3,
    ),
  ...
  LURE: () =>
    new DoubleBattleChanceBoosterModifierType(
      "modifierType:ModifierType.LURE",
      "lure",
      10,
    ),
  SUPER_LURE: () =>
    new DoubleBattleChanceBoosterModifierType(
      "modifierType:ModifierType.SUPER_LURE",
      "super_lure",
      15,
    ),
  MAX_LURE: () =>
    new DoubleBattleChanceBoosterModifierType(
      "modifierType:ModifierType.MAX_LURE",
      "max_lure",
      30,
    ),

  SPECIES_STAT_BOOSTER: () =>
    new SpeciesStatBoosterModifierTypeGenerator(false),
  RARE_SPECIES_STAT_BOOSTER: () =>
    new SpeciesStatBoosterModifierTypeGenerator(true),

  TEMP_STAT_STAGE_BOOSTER: () =>
    new TempStatStageBoosterModifierTypeGenerator(),
      ...
      getDescription(): string {
        return i18next.t(
          "modifierType:ModifierType.TempStatStageBoosterModifierType.description",
          {
            ...
            amount: i18next.t(
              "modifierType:ModifierType.TempStatStageBoosterModifierType.extra.stage",
            ),
          },
        );
      }
    })(
      "modifierType:ModifierType.DIRE_HIT",
      "dire_hit",
      (type, _args) => new TempCritBoosterModifier(type, 5),
    ),
  ...
  MINT: () =>
    new ModifierTypeGenerator((_party: Pokemon[], pregenArgs?: any[]) => {
      ...
      return new PokemonNatureChangeModifierType(
        randSeedInt(getEnumValues(Nature).length) as Nature,
      );
    }),
  ...
  TERA_SHARD: () =>
    new ModifierTypeGenerator((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      for (const p of party) {
        if (
          !(
            p.hasSpecies(Species.TERAPAGOS) ||
            p.hasSpecies(Species.OGERPON) ||
            p.hasSpecies(Species.SHEDINJA)
          )
        ) {
      ...
      if (
        teraTypes.length > 0 &&
        teraTypes.filter((t) => t === teraTypes[0]).length === teraTypes.length
      ) {
        excludedType = teraTypes[0];
      }
      let shardType = randSeedInt(64)
        ? (randSeedInt(18) as PokemonType)
        : PokemonType.STELLAR;
      while (shardType === excludedType) {
        shardType = randSeedInt(64)
          ? (randSeedInt(18) as PokemonType)
          : PokemonType.STELLAR;
      }
  ...
  EXP_SHARE: () =>
    new ModifierType(
      "modifierType:ModifierType.EXP_SHARE",
      "exp_share",
      (type, _args) => new ExpShareModifier(type),
    ),
  EXP_BALANCE: () =>
    new ModifierType(
  ...
  EXP_CHARM: () =>
    new ExpBoosterModifierType(
      "modifierType:ModifierType.EXP_CHARM",
      "exp_charm",
      25,
    ),
  SUPER_EXP_CHARM: () =>
    new ExpBoosterModifierType(
      "modifierType:ModifierType.SUPER_EXP_CHARM",
      "super_exp_charm",
      60,
    ),
  GOLDEN_EXP_CHARM: () =>
    new ExpBoosterModifierType(
      "modifierType:ModifierType.GOLDEN_EXP_CHARM",
      "golden_exp_charm",
      100,
    ),

  LUCKY_EGG: () =>
    new PokemonExpBoosterModifierType(
      "modifierType:ModifierType.LUCKY_EGG",
      "lucky_egg",
      40,
    ),
  GOLDEN_EGG: () =>
    new PokemonExpBoosterModifierType(
      "modifierType:ModifierType.GOLDEN_EGG",
      "golden_egg",
      100,
    ),

  SOOTHE_BELL: () =>
    new PokemonFriendshipBoosterModifierType(
      "modifierType:ModifierType.SOOTHE_BELL",
      "soothe_bell",
    ),
  ...
  EVIOLITE: () =>
    new PokemonHeldItemModifierType(
      ...
      "eviolite",
      (type, args) =>
        new EvolutionStatBoosterModifier(
          type,
          (args[0] as Pokemon).id,
          [Stat.DEF, Stat.SPDEF],
          1.5,
  ...
  SOUL_DEW: () =>
    new PokemonHeldItemModifierType(
      ...
      "soul_dew",
      (type, args) =>
        new PokemonNatureWeightModifier(type, (args[0] as Pokemon).id),
    ),
  ...
  GOLDEN_PUNCH: () =>
    new PokemonHeldItemModifierType(
      ...
      "golden_punch",
      (type, args) =>
        new DamageMoneyRewardModifier(type, (args[0] as Pokemon).id),
    ),
  COIN_CASE: () =>
    new ModifierType(
  ...
  GRIP_CLAW: () =>
    new ContactHeldItemTransferChanceModifierType(
      "modifierType:ModifierType.GRIP_CLAW",
      "grip_claw",
      10,
    ),
  WIDE_LENS: () =>
    new PokemonMoveAccuracyBoosterModifierType(
      "modifierType:ModifierType.WIDE_LENS",
      "wide_lens",
      5,
    ),

  MULTI_LENS: () =>
    new PokemonMultiHitModifierType(
      "modifierType:ModifierType.MULTI_LENS",
      "zoom_lens",
    ),
  ...
  QUICK_CLAW: () =>
    new PokemonHeldItemModifierType(
      ...
      "quick_claw",
      (type, args) =>
        new BypassSpeedChanceModifier(type, (args[0] as Pokemon).id),
    ),
  ...
  TOXIC_ORB: () =>
    new PokemonHeldItemModifierType(
      ...
      "toxic_orb",
      (type, args) =>
        new TurnStatusEffectModifier(type, (args[0] as Pokemon).id),
    ),
  FLAME_ORB: () =>
    new PokemonHeldItemModifierType(
  ...
  BATON: () =>
    new PokemonHeldItemModifierType(
      ...
      "baton",
      (type, args) =>
        new SwitchEffectTransferModifier(type, (args[0] as Pokemon).id),
    ),
  ...
  IV_SCANNER: () =>
    new ModifierType(
      "modifierType:ModifierType.IV_SCANNER",
      "scanner",
      (type, _args) => new IvScannerModifier(type),
    ),

  DNA_SPLICERS: () =>
    new FusePokemonModifierType(
      "modifierType:ModifierType.DNA_SPLICERS",
      "dna_splicers",
    ),

  MINI_BLACK_HOLE: () =>
    new TurnHeldItemTransferModifierType(
      "modifierType:ModifierType.MINI_BLACK_HOLE",
      "mini_black_hole",
    ),
  ...
  ENEMY_ENDURE_CHANCE: () =>
    new EnemyEndureChanceModifierType(
      "modifierType:ModifierType.ENEMY_ENDURE_CHANCE",
      "wl_reset_urge",
      2,
    ),
  ENEMY_FUSED_CHANCE: () =>
  ...
  MYSTERY_ENCOUNTER_OLD_GATEAU: () =>
    new ModifierTypeGenerator((_party: Pokemon[], pregenArgs?: any[]) => {
      if (pregenArgs) {
        return new PokemonBaseStatFlatModifierType(
          pregenArgs[0] as number,
          pregenArgs[1] as Stat[],
        );
      }
      return new PokemonBaseStatFlatModifierType(randSeedInt(20, 1), [
        Stat.HP,
        Stat.ATK,
        Stat.DEF,
      ]);
    ...
    new ModifierTypeGenerator((_party: Pokemon[], pregenArgs?: any[]) => {
      if (pregenArgs) {
        return new ModifierType(
          ...
          "black_sludge",
          (type, _args) =>
            new HealShopCostModifier(type, pregenArgs[0] as number),
        );
      }
      return new ModifierType(
        "modifierType:ModifierType.MYSTERY_ENCOUNTER_BLACK_SLUDGE",
  ...
  MYSTERY_ENCOUNTER_MACHO_BRACE: () =>
    new PokemonHeldItemModifierType(
      ...
      "macho_brace",
      (type, args) =>
        new PokemonIncrementingStatModifier(type, (args[0] as Pokemon).id),
    ),
...
function hasMaximumBalls(ballType: PokeballType): boolean {
  return (
    globalScene.gameMode.isClassic &&
    globalScene.pokeballCounts[ballType] >= MAX_PER_TYPE_POKEBALLS
  );
}
...
const modifierPool: ModifierPool = {
  [ModifierTier.COMMON]: [
    new WeightedModifierType(
      ...
      () => (hasMaximumBalls(PokeballType.POKEBALL) ? 0 : 6),
      6,
    ),
            ...
            (p) =>
              ...
              p
                ...
                .filter(
                  (m) =>
                    m.ppUsed &&
                    m.getMovePp() - m.ppUsed <= 5 &&
                    m.ppUsed > Math.floor(m.getMovePp() / 2),
                ).length,
          ).length,
          3,
        );
  ...
  [ModifierTier.GREAT]: [
    new WeightedModifierType(
      ...
      () => (hasMaximumBalls(PokeballType.GREAT_BALL) ? 0 : 6),
      6,
    ),
            ...
            (p) =>
              ...
              !p.getHeldItems().some((i) => {
                if (i instanceof TurnStatusEffectModifier) {
                  return (
                    (i as TurnStatusEffectModifier).getStatusEffect() ===
                    p.status?.effect
                  );
                }
                return false;
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        const faintedPartyMemberCount = Math.min(
          party.filter((p) => p.isFainted()).length,
          3,
        );
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        return party.filter((p) => p.isFainted()).length >=
          Math.ceil(party.length / 2)
          ? 1
          : 0;
      },
      1,
    ...
    new WeightedModifierType(
      ...
      skipInLastClassicWaveOrDefault(5),
    ),
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        ...
        const highestPartyLevel = party
          .map((p) => p.level)
          .reduce(
            (highestLevel: number, level: number) =>
  ...
  [ModifierTier.ULTRA]: [
    ...
    new WeightedModifierType(
      ...
      skipInLastClassicWaveOrDefault(3),
    ),
    new WeightedModifierType(modifierTypes.EVIOLITE, (party: Pokemon[]) => {
      const { gameMode, gameData } = globalScene;
      if (
        gameMode.isDaily ||
        (!gameMode.isFreshStartChallenge() &&
          gameData.isUnlocked(Unlockables.EVIOLITE))
      ) {
        return party.some((p) => {
      ...
      (party: Pokemon[]) => {
        ...
        return party.some(
          (p) =>
            !p
              .getHeldItems()
              .some((i) => i instanceof SpeciesCritBoosterModifier) &&
            (checkedSpecies.includes(p.getSpeciesForm(true).speciesId) ||
              (p.isFusion() &&
                checkedSpecies.includes(
                  p.getFusionSpeciesForm(true).speciesId,
                ))),
        )
          ? 12
      ...
      (party: Pokemon[]) => {
        return party.some((p) => {
          const isHoldingOrb = p
            .getHeldItems()
            .some(
              (i) => i.type.id === "FLAME_ORB" || i.type.id === "TOXIC_ORB",
            );
          ...
          if (!isHoldingOrb) {
            const moveset = p
              ...
              .map((m) => m.moveId);
            const canSetStatus = p.canSetStatus(
              StatusEffect.TOXIC,
              true,
              true,
              null,
            ...
            const hasStatusMoves = [Moves.FACADE, Moves.PSYCHO_SHIFT].some(
              (m) => moveset.includes(m),
            );
            ...
            if (canSetStatus) {
              ...
              const hasOppositeAbility = [Abilities.FLARE_BOOST].some((a) =>
        ...
        return party.some((p) => {
          ...
          if (!isHoldingOrb) {
            ...
            if (canSetStatus) {
              ...
              const hasSpecificAbility = [Abilities.FLARE_BOOST].some((a) =>
                p.hasAbility(a, false, true),
              );
    ...
    new WeightedModifierType(
      ...
      skipInLastClassicWaveOrDefault(2),
    ),
    new WeightedModifierType(
      modifierTypes.IV_SCANNER,
      skipInLastClassicWaveOrDefault(4),
    ),
    new WeightedModifierType(
      modifierTypes.EXP_CHARM,
      skipInLastClassicWaveOrDefault(8),
    ),
    new WeightedModifierType(
      modifierTypes.EXP_SHARE,
      skipInLastClassicWaveOrDefault(10),
    ),
    new WeightedModifierType(
      ...
      () =>
        !globalScene.gameMode.isClassic
          ? Math.min(
              Math.max(
                Math.floor(globalScene.currentBattle.waveIndex / 50) * 2,
                1,
              ),
              4,
            )
  ...
  [ModifierTier.ROGUE]: [
    new WeightedModifierType(
      ...
      () => (hasMaximumBalls(PokeballType.ROGUE_BALL) ? 0 : 16),
      16,
    ),
    new WeightedModifierType(
    ...
    new WeightedModifierType(
      ...
      () => (!globalScene.gameMode.isClassic ? 4 : 0),
      4,
    ),
    new WeightedModifierType(
      modifierTypes.ABILITY_CHARM,
      skipInClassicAfterWave(189, 6),
    ),
    new WeightedModifierType(modifierTypes.FOCUS_BAND, 5),
    new WeightedModifierType(modifierTypes.KINGS_ROCK, 3),
    new WeightedModifierType(modifierTypes.LOCK_CAPSULE, () =>
  ...
  [ModifierTier.MASTER]: [
    new WeightedModifierType(
      ...
      () => (hasMaximumBalls(PokeballType.MASTER_BALL) ? 0 : 24),
      24,
    ),
...
const wildModifierPool: ModifierPool = {
  [ModifierTier.COMMON]: [new WeightedModifierType(modifierTypes.BERRY, 1)].map(
    (m) => {
      m.setTier(ModifierTier.COMMON);
      return m;
    },
...
export function getModifierPoolForType(
 ...
 */
export const itemPoolChecks: Map<ModifierTypeKeys, boolean | undefined> =
  new Map();
...
export function regenerateModifierPoolThresholds(
    ...
    new Map(
      Object.keys(pool).map((t) => {
        ...
        pool[t].reduce((total: number, modifierType: WeightedModifierType) => {
          ...
          const weight =
            ...
            existingModifiers.find(
              (m) => m.stackCount < m.getMaxStackCount(true),
            )
          ...
          if (weightedModifierType.maxWeight) {
            ...
            const outputWeight = useMaxWeightForOutput
              ? weightedModifierType.maxWeight
              : weight;
          ...
          if (
            itemPoolChecks.has(modifierType.modifierType.id as ModifierTypeKeys)
          ) {
            itemPoolChecks.set(
              modifierType.modifierType.id as ModifierTypeKeys,
              true,
            );
          }
        ...
        for (const id of tierModifierIds) {
          modifierTableData[id].tierPercent =
            Math.floor((modifierTableData[id].weight / tierMaxWeight) * 10000) /
            100;
        }
  ...
  for (const id of Object.keys(modifierTableData)) {
    modifierTableData[id].totalPercent =
      Math.floor(
        modifierTableData[id].tierPercent *
          tierWeights[modifierTableData[id].tier] *
          100,
      ) / 100;
  ...
  if (!customModifierSettings) {
    new Array(count).fill(0).map((_, i) => {
      options.push(
        getModifierTypeOptionWithRetry(
          ...
          retryCount,
          party,
          modifierTiers && modifierTiers.length > i
            ? modifierTiers[i]
            : undefined,
        ),
      );
    ...
    if (
      ...
      customModifierSettings.guaranteedModifierTypeFuncs!.forEach((mod, _i) => {
        const modifierId = Object.keys(modifierTypes).find(
          (k) => modifierTypes[k] === mod,
        ) as string;
        ...
        const modType =
          guaranteedMod instanceof ModifierTypeGenerator
            ? guaranteedMod.generateType(party)
            : guaranteedMod;
        if (modType) {
    ...
    if (
      customModifierSettings.guaranteedModifierTiers &&
      customModifierSettings.guaranteedModifierTiers.length > 0
    ) {
      const allowLuckUpgrades =
        customModifierSettings.allowLuckUpgrades ?? true;
    ...
    if (options.length < count && customModifierSettings.fillRemaining) {
      while (options.length < count) {
        options.push(
          getModifierTypeOptionWithRetry(options, retryCount, party, undefined),
        );
      }
    }
  }
...
function getModifierTypeOptionWithRetry(
  ...
  let candidate = getNewModifierTypeOption(
    party,
    ModifierPoolType.PLAYER,
    tier,
    undefined,
  ...
  while (
    ...
    existingOptions.filter(
      (o) =>
        o.type.name === candidate?.type.name ||
        o.type.group === candidate?.type.group,
    ).length
  ) {
 ...
 */
export function overridePlayerModifierTypeOptions(
  options: ModifierTypeOption[],
  party: PlayerPokemon[],
) {
  const minLength = Math.min(
    options.length,
    Overrides.ITEM_REWARD_OVERRIDE.length,
  );
  for (let i = 0; i < minLength; i++) {
    ...
    if (modifierType instanceof ModifierTypeGenerator) {
      const pregenArgs =
        "type" in override && override.type !== null
          ? [override.type]
          : undefined;
...
export function getEnemyBuffModifierForWave(
  ...
  while (
    ++r < retryCount &&
    (matchingModifier = enemyModifiers.find(
      (m) => m.type.id === candidate?.type?.id,
    )) &&
    matchingModifier.getMaxStackCount() <
      matchingModifier.stackCount + (r < 10 ? tierStackCount : 1)
  ) {
...
export function getDailyRunStarterModifiers(
  party: PlayerPokemon[],
): PokemonHeldItemModifier[] {
...
function getNewModifierTypeOption(
  ...
  if (tier === undefined) {
    ...
    while (
      tier &&
      (!modifierPool.hasOwnProperty(tier) || !modifierPool[tier].length)
    ) {
      tier--;
      if (upgradeCount) {
        upgradeCount--;
    ...
    if (tier < ModifierTier.MASTER && allowLuckUpgrades) {
      ...
      const upgradeOdds = Math.floor(128 / ((partyLuckValue + 4) / 4));
      while (
        modifierPool.hasOwnProperty(tier + upgradeCount + 1) &&
        modifierPool[tier + upgradeCount + 1].length
      ) {
  ...
  if (player) {
    console.log(
      index,
      ignoredPoolIndexes[tier].filter((i) => i <= index).length,
      ignoredPoolIndexes[tier],
    );
  }
  ...
  if (modifierType instanceof ModifierTypeGenerator) {
    ...
    if (modifierType === null) {
      ...
      return getNewModifierTypeOption(
        party,
        poolType,
        tier,
        upgradeCount,
...
export function getDefaultModifierTypeForTier(
  ...
  let modifierType: ModifierType | WeightedModifierType =
    modifierPool[tier || ModifierTier.COMMON][0];
...
export function getPartyLuckValue(party: Pokemon[]): number {
  ...
  const luck = Phaser.Math.Clamp(
    party
      .map((p) =>
        p.isAllowedInBattle()
          ? p.getLuck() + (eventSpecies.includes(p.species.speciesId) ? 1 : 0)
          : 0,
      )
