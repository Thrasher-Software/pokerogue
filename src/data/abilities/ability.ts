...
export class PostBattleInitFormChangeAbAttr extends PostBattleInitAbAttr {
  ...
  override canApplyPostBattleInit(
    pokemon: Pokemon,
    passive: boolean,
    simulated: boolean,
    args: any[],
...
export class ReceivedMoveDamageMultiplierAbAttr extends PreDefendAbAttr {
  ...
  override applyPreDefend(
    ...
    (args[0] as NumberHolder).value = toDmgValue(
      (args[0] as NumberHolder).value * this.damageMultiplier,
    );
  }
}
...
export class ReceivedTypeDamageMultiplierAbAttr extends ReceivedMoveDamageMultiplierAbAttr {
  constructor(moveType: PokemonType, damageMultiplier: number) {
    super(
      (target, user, move) => user.getMoveType(move) === moveType,
      damageMultiplier,
      false,
    );
  }
...
export class TypeImmunityHealAbAttr extends TypeImmunityAbAttr {
  ...
  override canApplyPreDefend(
    ...
    return super.canApplyPreDefend(
      pokemon,
      passive,
      simulated,
      attacker,
  ...
  override applyPreDefend(
    ...
    if (!pokemon.isFullHp() && !simulated) {
      const abilityName = (
        !passive ? pokemon.getAbility() : pokemon.getPassiveAbility()
      ).name;
  ...
  override canApplyPreDefend(
    ...
    const modifierValue =
      args.length > 0
        ...
        : pokemon.getAttackTypeEffectiveness(
            attacker.getMoveType(move),
            attacker,
            undefined,
            undefined,
            move,
...
export class FullHpResistTypeAbAttr extends PreDefendAbAttr {
  override canApplyPreDefend(
    ...
    return (
      ...
      !(move && move.hasAttr(FixedDamageAttr)) &&
      pokemon.isFullHp() &&
  ...
  override canApplyPreDefend(
    ...
    return (
      !(
        ...
        move.moveTarget === MoveTarget.NEAR_ALLY
      ) &&
...
export class MoveImmunityAbAttr extends PreDefendAbAttr {
  ...
  getTriggerMessage(
    ...
    return i18next.t("abilityTriggers:moveImmunity", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
    });
  }
}
  ...
  override applyPostDefend(
    ...
    if (!simulated) {
      globalScene.queueMessage(
        i18next.t("abilityTriggers:reverseDrain", {
...
export class PostDefendStatStageChangeAbAttr extends PostDefendAbAttr {
  ...
  override applyPostDefend(
    ...
    if (this.allOthers) {
      ...
      const otherPokemon = !isNullOrUndefined(ally)
        ? pokemon.getOpponents().concat([ally])
...
export class PostDefendHpGatedStatStageChangeAbAttr extends PostDefendAbAttr {
  ...
  override canApplyPostDefend(
    ...
    const lastAttackReceived =
      pokemon.turnData.attacksReceived[
        pokemon.turnData.attacksReceived.length - 1
      ];
...
export class PostDefendTypeChangeAbAttr extends PostDefendAbAttr {
  ...
  override canApplyPostDefend(
    ...
    return (
      ...
      (simulated || pokemonTypes.length !== 1 || pokemonTypes[0] !== this.type)
    );
  }
...
export class PostDefendTerrainChangeAbAttr extends PostDefendAbAttr {
  ...
  override canApplyPostDefend(
    ...
    return (
      hitResult < HitResult.NO_EFFECT &&
      globalScene.arena.canSetTerrain(this.terrainType)
    );
  }
...
export class EffectSporeAbAttr extends PostDefendContactApplyStatusEffectAbAttr {
  ...
  override canApplyPostDefend(
    ...
    return (
      !(
        attacker.hasAbility(Abilities.OVERCOAT) ||
        attacker.isOfType(PokemonType.GRASS)
      ) &&
      super.canApplyPostDefend(
        pokemon,
        passive,
        simulated,
        attacker,
...
export class PostDefendContactDamageAbAttr extends PostDefendAbAttr {
  ...
  override applyPostDefend(
    ...
    attacker.turnData.damageTaken += toDmgValue(
      attacker.getMaxHp() * (1 / this.damageRatio),
    );
  }
...
export class PostStatStageChangeStatStageChangeAbAttr extends PostStatStageChangeAbAttr {
  ...
  constructor(
    condition: PokemonStatStageChangeCondition,
    statsToChange: BattleStat[],
    stages: number,
  ) {
    super(true);
  ...
  override canApplyPostStatStageChange(
    ...
    return (
      this.condition(pokemon, statStagesChanged, stagesChanged) && !selfTarget
    );
  }
...
export class MoveEffectChanceMultiplierAbAttr extends AbAttr {
  ...
  override canApply(
    ...
    return !(
      (args[0] as NumberHolder).value <= 0 ||
      exceptMoves.includes((args[1] as Move).id)
    );
  }
...
export class MoveTypePowerBoostAbAttr extends MovePowerBoostAbAttr {
  constructor(boostedType: PokemonType, powerMultiplier?: number) {
    super(
      (pokemon, defender, move) => pokemon?.getMoveType(move) === boostedType,
      powerMultiplier || 1.5,
      false,
    );
  }
...
export class VariableMovePowerBoostAbAttr extends VariableMovePowerAbAttr {
   ...
   */
  constructor(
    mult: (user: Pokemon, target: Pokemon, move: Move) => number,
    showAbility = true,
  ) {
    super(showAbility);
    this.mult = mult;
...
export class AllyMoveCategoryPowerBoostAbAttr extends FieldMovePowerBoostAbAttr {
  ...
  constructor(boostedCategories: MoveCategory[], powerMultiplier: number) {
    super(
      (pokemon, defender, move) => boostedCategories.includes(move.category),
      powerMultiplier,
    );
  }
}
...
export class StatMultiplierAbAttr extends AbAttr {
  ...
  canApplyStatStage(
    ...
    return (
      stat === this.stat &&
      (!this.condition || this.condition(pokemon, null, move))
    );
  }
...
export class PostAttackAbAttr extends AbAttr {
  ...
  constructor(
    attackCondition: PokemonAttackCondition = (user, target, move) =>
      move.category !== MoveCategory.STATUS,
    showAbility = true,
  ) {
    super(showAbility);
...
export class PostAttackStealHeldItemAbAttr extends PostAttackAbAttr {
  ...
  override canApplyPostAttack(
    ...
    if (
      ...
      const heldItems = this.getTargetHeldItems(defender).filter(
        (i) => i.isTransferable,
      );
      if (heldItems.length) {
        // Ensure that the stolen item in testing is the same as when the effect is applied
        this.stolenItem =
          heldItems[pokemon.randBattleSeedInt(heldItems.length)];
  ...
  override applyPostAttack(
    ...
    if (
      globalScene.tryTransferHeldItemModifier(this.stolenItem, pokemon, false)
    ) {
      globalScene.queueMessage(
...
export class PostDefendStealHeldItemAbAttr extends PostDefendAbAttr {
  ...
  override canApplyPostDefend(
    ...
    if (
      ...
      const heldItems = this.getTargetHeldItems(attacker).filter(
        (i) => i.isTransferable,
      );
      if (heldItems.length) {
        this.stolenItem =
...
class PostVictoryStatStageChangeAbAttr extends PostVictoryAbAttr {
  ...
  override applyPostVictory(
    ...
    const stat =
      typeof this.stat === "function" ? this.stat(pokemon) : this.stat;
    if (!simulated) {
      globalScene.unshiftPhase(
        new StatStageChangePhase(
          pokemon.getBattlerIndex(),
...
export class CopyFaintedAllyAbilityAbAttr extends PostKnockOutAbAttr {
  ...
  override canApplyPostKnockOut(
    ...
    return (
      pokemon.isPlayer() === knockedOut.isPlayer() &&
      knockedOut.getAbility().isCopiable
    );
  }
...
export class PostSummonRemoveArenaTagAbAttr extends PostSummonAbAttr {
  ...
  override canApplyPostSummon(
    pokemon: Pokemon,
    passive: boolean,
    simulated: boolean,
    args: any[],
  ): boolean {
    return globalScene.arena.tags.some((tag) =>
      this.arenaTags.includes(tag.tagType),
    );
  }
...
export class PostSummonAddArenaTagAbAttr extends PostSummonAbAttr {
  ...
  public override applyPostSummon(
    pokemon: Pokemon,
    passive: boolean,
    simulated: boolean,
    args: any[],
...
export class PostSummonRemoveBattlerTagAbAttr extends PostSummonRemoveEffectAbAttr {
  ...
  public override canApplyPostSummon(
    pokemon: Pokemon,
    passive: boolean,
    simulated: boolean,
    args: any[],
...
export class PostSummonWeatherChangeAbAttr extends PostSummonAbAttr {
  ...
  override canApplyPostSummon(
    ...
    const weatherReplaceable =
      ...
      !globalScene.arena.weather?.isImmutable();
    return (
      weatherReplaceable && globalScene.arena.canSetWeather(this.weatherType)
    );
  }
...
export class PostSummonHealStatusAbAttr extends PostSummonRemoveEffectAbAttr {
  ...
  public override canApplyPostSummon(
    ...
    return (
      ...
      (this.immuneEffects.length < 1 || this.immuneEffects.includes(status))
    );
  }
  ...
  public override getTriggerMessage(
    ...
    if (this.statusHealed) {
      return getStatusEffectHealText(
        this.statusHealed,
        getPokemonNameWithAffix(_pokemon),
      );
    }
    return null;
  }
...
export class PostSummonCopyAbilityAbAttr extends PostSummonAbAttr {
  ...
  override canApplyPostSummon(
    ...
    if (
      ...
      !(
        pokemon.hasAbility(Abilities.TRACE) &&
        target!.getAbility().id === Abilities.WONDER_GUARD
      )
    ) {
      return false;
    }
  ...
  override applyPostSummon(
    ...
    if (!simulated) {
      for (const pokemon of allowedParty) {
        if (
          pokemon.status &&
          this.statusEffect.includes(pokemon.status.effect)
        ) {
          globalScene.queueMessage(
            getStatusEffectHealText(
...
export class PostSummonFormChangeByWeatherAbAttr extends PostSummonAbAttr {
  ...
  override canApplyPostSummon(
    ...
    const isCastformWithForecast =
      pokemon.species.speciesId === Species.CASTFORM &&
      this.ability === Abilities.FORECAST;
    const isCherrimWithFlowerGift =
      pokemon.species.speciesId === Species.CHERRIM &&
      this.ability === Abilities.FLOWER_GIFT;
...
export class CommanderAbAttr extends AbAttr {
  ...
  override apply(
    ...
    if (!simulated) {
      ...
      pokemon
        .getAlly()
        ?.addTag(BattlerTagType.COMMANDED, 0, Moves.NONE, pokemon.id);
...
export class PreLeaveFieldClearWeatherAbAttr extends PreLeaveFieldAbAttr {
  override canApplyPreLeaveField(
    pokemon: Pokemon,
    passive: boolean,
    simulated: boolean,
    args: any[],
...
export class PreLeaveFieldRemoveSuppressAbilitiesSourceAbAttr extends PreLeaveFieldAbAttr {
  ...
  public override applyPreLeaveField(
    pokemon: Pokemon,
    passive: boolean,
    simulated: boolean,
    args: any[],
  ): void {
    const suppressTag = globalScene.arena.getTag(
...
export class ReflectStatStageChangeAbAttr extends PreStatStageChangeAbAttr {
  ...
  getTriggerMessage(
    ...
    return i18next.t("abilityTriggers:protectStat", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      abilityName,
      statName: this.reflectedStat
        ? i18next.t(getStatKey(this.reflectedStat))
...
export class ProtectStatAbAttr extends PreStatStageChangeAbAttr {
  ...
  getTriggerMessage(
    ...
    return i18next.t("abilityTriggers:protectStat", {
      pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
      abilityName,
      statName: this.protectedStat
        ? i18next.t(getStatKey(this.protectedStat))
        : i18next.t("battle:stats"),
    });
  }
}
...
export class PreSetStatusEffectImmunityAbAttr extends PreSetStatusAbAttr {
  ...
  override canApplyPreSetStatus(
    ...
    return (
      (effect !== StatusEffect.FAINT && this.immuneEffects.length < 1) ||
...
export class ConditionalUserFieldStatusEffectImmunityAbAttr extends UserFieldStatusEffectImmunityAbAttr {
  ...
  constructor(
    condition: (target: Pokemon, source: Pokemon | null) => boolean,
...
export class ConditionalUserFieldProtectStatAbAttr extends PreStatStageChangeAbAttr {
  ...
  constructor(
    condition: (target: Pokemon) => boolean,
    protectedStat?: BattleStat,
  ) {
    super();
    this.condition = condition;
  }
...
export class PreApplyBattlerTagImmunityAbAttr extends PreApplyBattlerTagAbAttr {
  ...
  constructor(immuneTagTypes: BattlerTagType | BattlerTagType[]) {
    ...
    this.immuneTagTypes = Array.isArray(immuneTagTypes)
      ? immuneTagTypes
      : [immuneTagTypes];
  }
...
export class ConditionalUserFieldBattlerTagImmunityAbAttr extends UserFieldBattlerTagImmunityAbAttr {
  ...
  override canApplyPreApplyBattlerTag(
    ...
    return (
      super.canApplyPreApplyBattlerTag(
        pokemon,
        passive,
        simulated,
        tag,
  ...
  constructor(
    condition: (target: Pokemon) => boolean,
    immuneTagTypes: BattlerTagType | BattlerTagType[],
  ) {
...
export class ChangeMovePriorityAbAttr extends AbAttr {
   ...
   */
  constructor(
    moveFunc: (pokemon: Pokemon, move: Move) => boolean,
    changeAmount: number,
  ) {
    super(false);
...
export class BlockWeatherDamageAttr extends PreWeatherDamageAbAttr {
  ...
  override canApplyPreWeatherEffect(
    ...
    return (
      ...
      this.weatherTypes.indexOf(weather?.weatherType) > -1
    );
  }
...
function getSheerForceHitDisableAbCondition(): AbAttrCondition {
  return (pokemon: Pokemon) => {
    ...
    const lastAttacker = pokemon
      .getOpponents()
      .find((p) => p.id === lastReceivedAttack.sourceId);
    if (!lastAttacker) {
      return true;
    }
    ...
    const SheerForceAffected =
      allMoves[lastReceivedAttack.move].chance >= 0 &&
      lastAttacker.hasAbility(Abilities.SHEER_FORCE);
...
export class PostWeatherChangeAddBattlerTagAttr extends PostWeatherChangeAbAttr {
  ...
  override canApplyPostWeatherChange(
    ...
    return (
      ...
      pokemon.canAddTag(this.tagType)
    );
  }
  ...
  override applyPostWeatherLapse(
    ...
    if (!simulated) {
      ...
      pokemon.damageAndUpdate(
        toDmgValue(pokemon.getMaxHp() / (16 / this.damageFactor)),
        { result: HitResult.INDIRECT },
      );
    }
  }
...
export class PostTerrainChangeAddBattlerTagAttr extends PostTerrainChangeAbAttr {
  ...
  override canApplyPostTerrainChange(
    ...
    return (
      !!this.terrainTypes.find((t) => t === terrain) &&
      pokemon.canAddTag(this.tagType)
    );
  }
...
export class PostTurnStatusHealAbAttr extends PostTurnAbAttr {
  ...
  override canApplyPostTurn(
    ...
    return (
      ...
      this.effects.includes(pokemon.status.effect) &&
      !pokemon.isFullHp()
    );
  }
...
export class PostTurnResetStatusAbAttr extends PostTurnAbAttr {
  ...
  override applyPostTurn(
    ...
    if (!simulated && this.target?.status) {
      globalScene.queueMessage(
        getStatusEffectHealText(
          this.target.status?.effect,
          getPokemonNameWithAffix(this.target),
        ),
      );
...
export class PostTurnRestoreBerryAbAttr extends PostTurnAbAttr {
  ...
  createEatenBerry(pokemon: Pokemon): boolean {
    ...
    if (berryModifier) {
      ...
      const newBerry = new BerryModifier(
        chosenBerry,
        pokemon.id,
        chosenBerryType,
        1,
...
export class RepeatBerryNextTurnAbAttr extends PostTurnAbAttr {
  ...
  override apply(
    ...
    for (const berryType of pokemon.summonData.berriesEatenLast) {
      ...
      const bMod = new BerryModifier(
        new BerryModifierType(berryType),
        pokemon.id,
        berryType,
        1,
      );
  ...
  override applyPostTurn(
    ...
    if (!simulated) {
      ...
      if (canLower.length > 0) {
        const loweredStat =
          canLower[pokemon.randBattleSeedInt(canLower.length)];
        globalScene.unshiftPhase(
          new StatStageChangePhase(
            pokemon.getBattlerIndex(),
            true,
...
export class SpeedBoostAbAttr extends PostTurnAbAttr {
  ...
  override canApplyPostTurn(
    ...
    return (
      simulated ||
      (!pokemon.turnData.switchedInThisTurn && !pokemon.turnData.failedRunAway)
    );
  }
  ...
  override applyPostTurn(
    ...
    globalScene.unshiftPhase(
      new StatStageChangePhase(pokemon.getBattlerIndex(), true, [Stat.SPD], 1),
    );
  }
}
...
export class PostTurnHurtIfSleepingAbAttr extends PostTurnAbAttr {
  override canApplyPostTurn(
    ...
    return pokemon
      ...
      .some(
        (opp) =>
          (opp.status?.effect === StatusEffect.SLEEP ||
            opp.hasAbility(Abilities.COMATOSE)) &&
    ...
    for (const opp of pokemon.getOpponents()) {
      if (
        ...
        if (!simulated) {
          ...
          globalScene.queueMessage(
            i18next.t("abilityTriggers:badDreams", {
...
export class FetchBallAbAttr extends PostTurnAbAttr {
  ...
  override canApplyPostTurn(
    ...
    return (
      !simulated &&
      !isNullOrUndefined(globalScene.currentBattle.lastUsedPokeball) &&
      !!pokemon.isPlayer
    );
  }
...
export class PostBiomeChangeWeatherChangeAbAttr extends PostBiomeChangeAbAttr {
  ...
  override canApply(
    ...
    return (
      (globalScene.arena.weather?.isImmutable() ?? false) &&
      globalScene.arena.canSetWeather(this.weatherType)
    );
  }
...
export class PostDancingMoveAbAttr extends PostMoveUsedAbAttr {
  ...
  override applyPostMoveUsed(
    ...
    if (!simulated) {
      ...
      if (
        move.getMove() instanceof AttackMove ||
        move.getMove() instanceof StatusMove
      ) {
        const target = this.getTarget(dancer, source, targets);
        globalScene.unshiftPhase(
          new MovePhase(dancer, target, move, true, true),
        );
      } else if (move.getMove() instanceof SelfStatusMove) {
        // If the move is a SelfStatusMove (ie. Swords Dance) the Dancer should replicate it on itself
        globalScene.unshiftPhase(
          new MovePhase(dancer, [dancer.getBattlerIndex()], move, true, true),
        );
      }
    }
  }
...
export class PostFaintContactDamageAbAttr extends PostFaintAbAttr {
  ...
  override canApplyPostFaint(
    ...
    globalScene
      .getField(true)
      .map((p) =>
        applyAbAttrs(FieldPreventExplosiveMovesAbAttr, p, cancelled, simulated),
      );
    if (
      !diedToDirectDamage ||
      cancelled.value ||
...
export class RedirectMoveAbAttr extends AbAttr {
  ...
  canRedirect(moveId: Moves, user: Pokemon): boolean {
    ...
    return !![MoveTarget.NEAR_OTHER, MoveTarget.OTHER].find(
      (t) => move.moveTarget === t,
    );
  }
}
...
export class RedirectTypeMoveAbAttr extends RedirectMoveAbAttr {
  ...
  canRedirect(moveId: Moves, user: Pokemon): boolean {
    return (
      super.canRedirect(moveId, user) &&
      user.getMoveType(allMoves[moveId]) === this.type
    );
  }
}
...
export class IgnoreTypeImmunityAbAttr extends AbAttr {
  ...
  override canApply(
    ...
    return (
      this.defenderType === (args[1] as PokemonType) &&
      this.allowedMoveTypes.includes(args[0] as PokemonType)
    );
  }
...
export class IgnoreTypeStatusEffectImmunityAbAttr extends AbAttr {
  ...
  override canApply(
    ...
    return (
      this.statusEffect.includes(args[0] as StatusEffect) &&
      this.defenderType.includes(args[1] as PokemonType)
    );
  }
...
export class IllusionPreSummonAbAttr extends PreSummonAbAttr {
  ...
  override applyPreSummon(
    ...
    const lastPokemon: Pokemon =
      party.filter((p) => p !== pokemon).at(-1) || pokemon;
    pokemon.setIllusion(lastPokemon);
  }

  override canApplyPreSummon(
    pokemon: Pokemon,
    passive: boolean,
    args: any[],
  ): boolean {
    if (pokemon.hasTrainer()) {
      ...
      if (
        lastPokemon === pokemon ||
        ((speciesId === Species.OGERPON || speciesId === Species.TERAPAGOS) &&
...
export class BypassSpeedChanceAbAttr extends AbAttr {
  ...
  override canApply(
    ...
    const move = turnCommand?.move?.move
      ? allMoves[turnCommand.move.move]
      : null;
    const isDamageMove =
...
export class TerrainEventTypeChangeAbAttr extends PostSummonAbAttr {
  ...
  override apply(
    ...
    const typeChange: PokemonType[] = this.determineTypeChange(
      pokemon,
      currentTerrain,
    );
    if (typeChange.length !== 0) {
      if (
        pokemon.summonData.addedType &&
        typeChange.includes(pokemon.summonData.addedType)
      ) {
  ...
  private determineTypeChange(
    ...
    switch (currentTerrain) {
      ...
      case TerrainType.DRAGON:
        typeChange.push(PokemonType.DRAGON);
        break;
      default:
  ...
  override getTriggerMessage(
    ...
    if (currentTerrain === TerrainType.NONE) {
      return i18next.t("abilityTriggers:pokemonTypeChangeRevert", {
        pokemonNameWithAffix,
      });
    } else {
      const moveType = i18next.t(
        `pokemonInfo:Type.${PokemonType[this.determineTypeChange(pokemon, currentTerrain)[0]]}`,
      );
      return i18next.t("abilityTriggers:pokemonTypeChange", {
        pokemonNameWithAffix,
        moveType,
...
function applySingleAbAttrs<TAttr extends AbAttr>(
  ...
  if (
    !pokemon?.canApplyAbility(passive) ||
    (passive && pokemon.getPassiveAbility().id === pokemon.getAbility().id)
  ) {
    return;
  }
  ...
  if (
    ...
    ability
      ...
      .some(
        (attr) =>
          attr instanceof PostSummonAbAttr && !attr.shouldActivateOnGain(),
      )
  ) {
    return;
  }
...
class ForceSwitchOutHelper {
  ...
  public switchOutLogic(pokemon: Pokemon): boolean {
    ...
    if (switchOutTarget instanceof PlayerPokemon) {
      if (
        globalScene
          .getPlayerParty()
          .filter((p) => p.isAllowedInBattle() && !p.isOnField()).length < 1
      ) {
        return false;
      }
      ...
      if (!allyPokemon?.isActive(true)) {
        ...
        if (switchOutTarget.hp) {
          ...
          if (
            globalScene.gameMode.hasRandomBiomes ||
            globalScene.isNewBiome()
          ) {
  ...
  public getFailedText(target: Pokemon): string | null {
    ...
    return blockedByAbility.value
      ? i18next.t("moveTriggers:cannotBeSwitchedOut", {
...
function calculateShellBellRecovery(pokemon: Pokemon): number {
  const shellBellModifier = pokemon
    .getHeldItems()
    .find((m) => m instanceof HitHealModifier);
  if (shellBellModifier) {
    return (
      toDmgValue(pokemon.turnData.totalDamageDealt / 8) *
      shellBellModifier.stackCount
    );
  }
  return 0;
}
...
export class PostDamageForceSwitchAbAttr extends PostDamageAbAttr {
  private helper: ForceSwitchOutHelper = new ForceSwitchOutHelper(
    SwitchType.SWITCH,
  );
  ...
  public override canApplyPostDamage(
    ...
    const fordbiddenAttackingMoves = [
      Moves.BELLY_DRUM,
      Moves.SUBSTITUTE,
      Moves.CURSE,
      Moves.PAIN_SPLIT,
    ...
    if (source) {
      ...
      if (enemyMoveHistory.length > 0) {
        ...
        if (
          ...
          (enemyLastMoveUsed.move === Moves.SKY_DROP &&
          ...
          allMoves[enemyLastMoveUsed.move].chance >= 0 &&
          source.hasAbility(Abilities.SHEER_FORCE)
        ) {
          return false;
...
export function applyPostBattleInitAbAttrs(
  ...
  applyAbAttrsInternal<PostBattleInitAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostBattleInit(pokemon, passive, simulated, args),
    (attr, passive) =>
      attr.canApplyPostBattleInit(pokemon, passive, simulated, args),
    args,
    simulated,
  );
}
...
export function applyPostMoveUsedAbAttrs(
  ...
  applyAbAttrsInternal<PostMoveUsedAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostMoveUsed(pokemon, move, source, targets, simulated, args),
    (attr, passive) =>
      attr.canApplyPostMoveUsed(
        pokemon,
        move,
        source,
        targets,
...
export function applyStatMultiplierAbAttrs(
  ...
  applyAbAttrsInternal<StatMultiplierAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyStatStage(pokemon, passive, simulated, stat, statValue, args),
    (attr, passive) =>
      attr.canApplyStatStage(
        pokemon,
        passive,
        simulated,
        stat,
...
export function applyPostDamageAbAttrs(
  ...
  applyAbAttrsInternal<PostDamageAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostDamage(pokemon, damage, passive, simulated, args, source),
    (attr, passive) =>
      attr.canApplyPostDamage(
        pokemon,
        damage,
        passive,
        simulated,
...
export function applyPreAttackAbAttrs(
  ...
  applyAbAttrsInternal<PreAttackAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPreAttack(pokemon, passive, simulated, defender, move, args),
    (attr, passive) =>
      attr.canApplyPreAttack(pokemon, passive, simulated, defender, move, args),
    args,
    simulated,
  );
}
...
export function applyPostKnockOutAbAttrs(
  ...
  applyAbAttrsInternal<PostKnockOutAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostKnockOut(pokemon, passive, simulated, knockedOut, args),
    (attr, passive) =>
      attr.canApplyPostKnockOut(pokemon, passive, simulated, knockedOut, args),
    args,
    simulated,
  );
}
...
export function applyPostVictoryAbAttrs(
  ...
  applyAbAttrsInternal<PostVictoryAbAttr>(
    ...
    (attr, passive) =>
      attr.canApplyPostVictory(pokemon, passive, simulated, args),
    args,
    simulated,
  );
}
...
export function applyPostSummonAbAttrs(
  ...
  applyAbAttrsInternal<PostSummonAbAttr>(
    ...
    (attr, passive) =>
      attr.canApplyPostSummon(pokemon, passive, simulated, args),
    args,
    simulated,
  );
}
...
export function applyPreSwitchOutAbAttrs(
  ...
  applyAbAttrsInternal<PreSwitchOutAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPreSwitchOut(pokemon, passive, simulated, args),
    (attr, passive) =>
      attr.canApplyPreSwitchOut(pokemon, passive, simulated, args),
    args,
    simulated,
  );
}
...
export function applyPreLeaveFieldAbAttrs(
  ...
  return applyAbAttrsInternal<PreLeaveFieldAbAttr>(
    ...
    (attr, passive) =>
      attr.canApplyPreLeaveField(pokemon, passive, simulated, args),
    args,
    simulated,
  );
}
...
export function applyPreStatStageChangeAbAttrs<
  T extends PreStatStageChangeAbAttr,
>(
  ...
  applyAbAttrsInternal<T>(
    ...
    (attr, passive) =>
      attr.canApplyPreStatStageChange(
        pokemon,
        passive,
        simulated,
        stat,
...
export function applyPostStatStageChangeAbAttrs(
  ...
  applyAbAttrsInternal<PostStatStageChangeAbAttr>(
    ...
    (attr, _passive) =>
      attr.canApplyPostStatStageChange(
        pokemon,
        simulated,
        stats,
        stages,
...
export function applyPreApplyBattlerTagAbAttrs(
  ...
  applyAbAttrsInternal<PreApplyBattlerTagAbAttr>(
    ...
    (attr, passive) =>
      attr.canApplyPreApplyBattlerTag(
        pokemon,
        passive,
        simulated,
        tag,
...
export function applyPostWeatherChangeAbAttrs(
  ...
  applyAbAttrsInternal<PostWeatherChangeAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostWeatherChange(pokemon, passive, simulated, weather, args),
    (attr, passive) =>
      attr.canApplyPostWeatherChange(
        pokemon,
        passive,
        simulated,
        weather,
...
export function applyPostWeatherLapseAbAttrs(
  ...
  applyAbAttrsInternal<PostWeatherLapseAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostWeatherLapse(pokemon, passive, simulated, weather, args),
    (attr, passive) =>
      attr.canApplyPostWeatherLapse(pokemon, passive, simulated, weather, args),
    args,
    simulated,
  );
}
...
export function applyPostTerrainChangeAbAttrs(
  ...
  applyAbAttrsInternal<PostTerrainChangeAbAttr>(
    ...
    pokemon,
    (attr, passive) =>
      attr.applyPostTerrainChange(pokemon, passive, simulated, terrain, args),
    (attr, passive) =>
      attr.canApplyPostTerrainChange(
        pokemon,
        passive,
        simulated,
        terrain,
...
export function applyPostBattleAbAttrs(
  ...
  applyAbAttrsInternal<PostBattleAbAttr>(
    ...
    (attr, passive) =>
      attr.canApplyPostBattle(pokemon, passive, simulated, args),
    args,
    simulated,
  );
}
 ...
 */
export function applyOnLoseAbAttrs(
  pokemon: Pokemon,
  passive = false,
  simulated = false,
  ...args: any[]
  ...
  applySingleAbAttrs<PreLeaveFieldAbAttr>(
    ...
    PreLeaveFieldAbAttr,
    (attr, passive) =>
      attr.applyPreLeaveField(pokemon, passive, simulated, [...args, true]),
    (attr, passive) =>
      attr.canApplyPreLeaveField(pokemon, passive, simulated, [...args, true]),
    args,
    true,
    simulated,
  );
...
function getPokemonWithWeatherBasedForms() {
  return globalScene
    ...
    .filter(
      (p) =>
        (p.hasAbility(Abilities.FORECAST) &&
          p.species.speciesId === Species.CASTFORM) ||
        (p.hasAbility(Abilities.FLOWER_GIFT) &&
          p.species.speciesId === Species.CHERRIM),
    );
}
...
export function initAbilities() {
  allAbilities.push(
    ...
    new Ability(Abilities.STENCH, 3).attr(
      ...
      false,
      (user, target, move) =>
        !move.hasAttr(FlinchAttr) && !move.hitsSubstitute(user, target)
          ? 10
          : 0,
    ...
    new Ability(Abilities.CLOUD_NINE, 3)
      ...
      .attr(
        ...
        i18next.t("abilityTriggers:weatherEffectDisappeared"),
      )
      .attr(PostSummonWeatherSuppressedFormChangeAbAttr)
      .attr(PostFaintUnsuppressedWeatherFormChangeAbAttr)
      .bypassFaint(),
    new Ability(Abilities.COMPOUND_EYES, 3).attr(
    ...
    new Ability(Abilities.SUCTION_CUPS, 3)
      ...
      .ignorable(),
    new Ability(Abilities.INTIMIDATE, 3).attr(
    ...
    new Ability(Abilities.SHADOW_TAG, 3).attr(
      ArenaTrapAbAttr,
      (user, target) => {
    ...
    new Ability(Abilities.LIGHTNING_ROD, 3)
      ...
      .ignorable(),
    new Ability(Abilities.SERENE_GRACE, 3).attr(
    ...
    new Ability(Abilities.TRACE, 3)
      ...
      .uncopiable(),
    new Ability(Abilities.HUGE_POWER, 3).attr(
      StatMultiplierAbAttr,
      Stat.ATK,
      2,
    ),
    ...
    new Ability(Abilities.WATER_VEIL, 3)
      ...
      .ignorable(),
    new Ability(Abilities.MAGNET_PULL, 3).attr(
      ArenaTrapAbAttr,
      (user, target) => {
        if (
          target.getTypes(true).includes(PokemonType.STEEL) ||
          (target.getTypes(true).includes(PokemonType.STELLAR) &&
            target.getTypes().includes(PokemonType.STEEL))
        ) {
          return true;
        }
        return false;
    ...
    new Ability(Abilities.SOUNDPROOF, 3)
      .attr(
        ...
        (pokemon, attacker, move) =>
          pokemon !== attacker && move.hasFlag(MoveFlags.SOUND_BASED),
      )
      .ignorable(),
    ...
    new Ability(Abilities.PRESSURE, 3)
      ...
      .attr(PostSummonMessageAbAttr, (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonPressure", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
      ),
    new Ability(Abilities.THICK_FAT, 3)
      ...
      .ignorable(),
    new Ability(Abilities.EARLY_BIRD, 3).attr(
    ...
    new Ability(Abilities.PICKUP, 3)
      ...
      .unsuppressable(),
    new Ability(Abilities.TRUANT, 3).attr(
    ...
    new Ability(Abilities.CUTE_CHARM, 3).attr(
    ...
    new Ability(Abilities.PLUS, 3).conditionalAttr(
      (p) =>
        globalScene.currentBattle.double &&
        [Abilities.PLUS, Abilities.MINUS].some(
          (a) => p.getAlly()?.hasAbility(a) ?? false,
        ),
      StatMultiplierAbAttr,
      Stat.SPATK,
      1.5,
    ...
    new Ability(Abilities.OVERGROW, 3).attr(
      LowHpMoveTypePowerBoostAbAttr,
      PokemonType.GRASS,
    ),
    new Ability(Abilities.BLAZE, 3).attr(
      LowHpMoveTypePowerBoostAbAttr,
      PokemonType.FIRE,
    ),
    new Ability(Abilities.TORRENT, 3).attr(
      LowHpMoveTypePowerBoostAbAttr,
      PokemonType.WATER,
    ),
    new Ability(Abilities.SWARM, 3).attr(
      LowHpMoveTypePowerBoostAbAttr,
      PokemonType.BUG,
    ),
    ...
    new Ability(Abilities.PURE_POWER, 3).attr(
      StatMultiplierAbAttr,
      Stat.ATK,
      2,
    ),
    ...
    new Ability(Abilities.TANGLED_FEET, 4)
      .conditionalAttr(
        (pokemon) => !!pokemon.getTag(BattlerTagType.CONFUSED),
        StatMultiplierAbAttr,
        Stat.EVA,
        2,
      )
    ...
    new Ability(Abilities.STEADFAST, 4).attr(
    ...
    new Ability(Abilities.ANGER_POINT, 4).attr(
    ...
    new Ability(Abilities.QUICK_FEET, 4)
      .conditionalAttr(
        (pokemon) =>
          pokemon.status
            ? pokemon.status.effect === StatusEffect.PARALYSIS
            : false,
        StatMultiplierAbAttr,
        Stat.SPD,
        2,
    ...
    new Ability(Abilities.NO_GUARD, 4)
      ...
      .attr(DoubleBattleChanceAbAttr),
    new Ability(Abilities.STALL, 4).attr(
      ChangeMovePriorityAbAttr,
      (pokemon, move: Move) => true,
      -0.2,
    ),
    ...
    new Ability(Abilities.MOLD_BREAKER, 4)
      .attr(PostSummonMessageAbAttr, (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonMoldBreaker", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
      )
    ...
    new Ability(Abilities.ANTICIPATION, 4).conditionalAttr(
      ...
      (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonAnticipation", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
    ),
    ...
    new Ability(Abilities.TINTED_LENS, 4).attr(
      ...
      2,
      (user, target, move) =>
        (target?.getMoveEffectiveness(user!, move) ?? 1) <= 0.5,
    ),
    new Ability(Abilities.FILTER, 4)
      ...
      .ignorable(),
    new Ability(Abilities.SLOW_START, 4).attr(
      PostSummonAddBattlerTagAbAttr,
      BattlerTagType.SLOW_START,
      5,
    ),
    new Ability(Abilities.SCRAPPY, 4)
      .attr(IgnoreTypeImmunityAbAttr, PokemonType.GHOST, [
        PokemonType.NORMAL,
        PokemonType.FIGHTING,
      ])
      .attr(IntimidateImmunityAbAttr),
    ...
    new Ability(Abilities.HONEY_GATHER, 4).attr(MoneyAbAttr).unsuppressable(),
    ...
    new Ability(Abilities.HEALER, 5).conditionalAttr(
      (pokemon) => !isNullOrUndefined(pokemon.getAlly()) && randSeedInt(10) < 3,
      PostTurnResetStatusAbAttr,
      true,
    ),
    ...
    new Ability(Abilities.TELEPATHY, 5)
      .attr(
        MoveImmunityAbAttr,
        (pokemon, attacker, move) =>
          pokemon.getAlly() === attacker && move instanceof AttackMove,
      )
      .ignorable(),
    ...
    new Ability(Abilities.OVERCOAT, 5)
      ...
      .attr(
        MoveImmunityAbAttr,
        (pokemon, attacker, move) =>
          pokemon !== attacker && move.hasFlag(MoveFlags.POWDER_MOVE),
      )
      .ignorable(),
    new Ability(Abilities.POISON_TOUCH, 5).attr(
    ...
    new Ability(Abilities.ANALYTIC, 5).attr(
      ...
      (user, target, move) => {
        const movePhase = globalScene.findPhase(
          (phase) =>
            phase instanceof MovePhase && phase.pokemon.id !== user?.id,
        );
    ...
    new Ability(Abilities.ILLUSION, 5)
      ...
      .conditionalAttr(
        (pokemon) => pokemon.isAllowedInBattle(),
    ...
    new Ability(Abilities.MUMMY, 5)
      ...
      .bypassFaint(),
    new Ability(Abilities.MOXIE, 5).attr(
    ...
    new Ability(Abilities.JUSTIFIED, 5).attr(
      PostDefendStatStageChangeAbAttr,
      (target, user, move) =>
        user.getMoveType(move) === PokemonType.DARK &&
        move.category !== MoveCategory.STATUS,
      Stat.ATK,
      1,
    ),
    ...
    new Ability(Abilities.TURBOBLAZE, 5)
      .attr(PostSummonMessageAbAttr, (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonTurboblaze", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
      )
      .attr(MoveAbilityBypassAbAttr),
    new Ability(Abilities.TERAVOLT, 5)
      .attr(PostSummonMessageAbAttr, (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonTeravolt", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
      )
      .attr(MoveAbilityBypassAbAttr),
    ...
    new Ability(Abilities.BULLETPROOF, 6)
      .attr(
        MoveImmunityAbAttr,
        (pokemon, attacker, move) =>
          pokemon !== attacker && move.hasFlag(MoveFlags.BALLBOMB_MOVE),
      )
      .ignorable(),
    ...
    new Ability(Abilities.REFRIGERATE, 6).attr(
      ...
      PokemonType.ICE,
      1.2,
      (user, target, move) => move.type === PokemonType.NORMAL,
    ),
    ...
    new Ability(Abilities.GALE_WINGS, 6).attr(
      ChangeMovePriorityAbAttr,
      (pokemon, move) =>
        pokemon.isFullHp() && pokemon.getMoveType(move) === PokemonType.FLYING,
      1,
    ),
    ...
    new Ability(Abilities.GRASS_PELT, 6)
      .conditionalAttr(
        getTerrainCondition(TerrainType.GRASSY),
        StatMultiplierAbAttr,
        Stat.DEF,
        1.5,
      )
    ...
    new Ability(Abilities.DARK_AURA, 6)
      .attr(PostSummonMessageAbAttr, (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonDarkAura", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
      )
    ...
    new Ability(Abilities.FAIRY_AURA, 6)
      .attr(PostSummonMessageAbAttr, (pokemon: Pokemon) =>
        i18next.t("abilityTriggers:postSummonFairyAura", {
          pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
        }),
      )
    ...
    new Ability(Abilities.AURA_BREAK, 6)
      ...
      .conditionalAttr(
        (pokemon) =>
          globalScene
            .getField(true)
            .some((p) => p.hasAbility(Abilities.DARK_AURA)),
      ...
      .conditionalAttr(
        (pokemon) =>
          globalScene
            .getField(true)
            .some((p) => p.hasAbility(Abilities.FAIRY_AURA)),
        FieldMoveTypePowerBoostAbAttr,
        PokemonType.FAIRY,
        9 / 16,
      )
      .conditionalAttr(
        (pokemon) =>
          globalScene
            ...
            .some(
              (p) =>
                p.hasAbility(Abilities.DARK_AURA) ||
                p.hasAbility(Abilities.FAIRY_AURA),
            ),
        PostSummonMessageAbAttr,
        (pokemon: Pokemon) =>
          i18next.t("abilityTriggers:postSummonAuraBreak", {
            pokemonNameWithAffix: getPokemonNameWithAffix(pokemon),
          }),
      ),
    ...
    new Ability(Abilities.WATER_COMPACTION, 7).attr(
      PostDefendStatStageChangeAbAttr,
      (target, user, move) =>
        user.getMoveType(move) === PokemonType.WATER &&
        move.category !== MoveCategory.STATUS,
      Stat.DEF,
      2,
    ),
    ...
    new Ability(Abilities.SHIELDS_DOWN, 7)
      ...
      .attr(
        ...
        (p) => (p.formIndex % 7) + (p.getHpRatio() <= 0.5 ? 7 : 0),
      )
      .attr(
    ...
    new Ability(Abilities.WATER_BUBBLE, 7)
      ...
      .attr(PostSummonHealStatusAbAttr, StatusEffect.BURN)
      .ignorable(),
    new Ability(Abilities.STEELWORKER, 7).attr(
    ...
    new Ability(Abilities.LIQUID_VOICE, 7).attr(
      ...
      PokemonType.WATER,
      1,
      (user, target, move) => move.hasFlag(MoveFlags.SOUND_BASED),
    ),
    ...
    new Ability(Abilities.GALVANIZE, 7).attr(
      ...
      PokemonType.ELECTRIC,
      1.2,
      (_user, _target, move) => move.type === PokemonType.NORMAL,
    ),
    ...
    new Ability(Abilities.SCHOOLING, 7)
      ...
      .attr(PostSummonFormChangeAbAttr, (p) =>
        p.level < 20 || p.getHpRatio() <= 0.25 ? 0 : 1,
      )
    ...
    new Ability(Abilities.DISGUISE, 7)
      ...
      .attr(
        ...
        (target, user, move) =>
          !!target.getTag(BattlerTagType.DISGUISE) &&
    ...
    new Ability(Abilities.POWER_CONSTRUCT, 7)
      ...
      .conditionalAttr(
        ...
        PostSummonFormChangeAbAttr,
        (p) =>
          p.getHpRatio() <= 0.5 || p.getFormKey() === "10-complete" ? 5 : 3,
      )
      .conditionalAttr(
        (pokemon) => pokemon.formIndex === 3 || pokemon.formIndex === 5,
        PostTurnFormChangeAbAttr,
    ...
    new Ability(Abilities.BATTERY, 7).attr(
    ...
    new Ability(Abilities.FLUFFY, 7)
      ...
      .attr(
        ReceivedMoveDamageMultiplierAbAttr,
        (target, user, move) => user.getMoveType(move) === PokemonType.FIRE,
        2,
      )
      .ignorable(),
    new Ability(Abilities.DAZZLING, 7)
      .attr(FieldPriorityMoveImmunityAbAttr)
      .ignorable(),
    new Ability(Abilities.SOUL_HEART, 7).attr(
    ...
    new Ability(Abilities.NEUROFORCE, 7).attr(
      MovePowerBoostAbAttr,
      (user, target, move) =>
        (target?.getMoveEffectiveness(user!, move) ?? 1) >= 2,
      1.25,
    ),
    new Ability(Abilities.INTREPID_SWORD, 8).attr(
      PostSummonStatStageChangeAbAttr,
      [Stat.ATK],
      1,
      true,
    ),
    new Ability(Abilities.DAUNTLESS_SHIELD, 8).attr(
      PostSummonStatStageChangeAbAttr,
      [Stat.DEF],
      1,
      true,
    ...
    new Ability(Abilities.PUNK_ROCK, 8)
      ...
      .attr(
        ReceivedMoveDamageMultiplierAbAttr,
        (target, user, move) => move.hasFlag(MoveFlags.SOUND_BASED),
        0.5,
      )
      .ignorable(),
    ...
    new Ability(Abilities.ICE_SCALES, 8)
      .attr(
        ReceivedMoveDamageMultiplierAbAttr,
        (target, user, move) => move.category === MoveCategory.SPECIAL,
        0.5,
      )
      .ignorable(),
    ...
    new Ability(Abilities.ICE_FACE, 8)
      ...
      .attr(
        ...
        (target, user, move) =>
          move.category === MoveCategory.PHYSICAL &&
          !!target.getTag(BattlerTagType.ICE_FACE),
        0,
        BattlerTagType.ICE_FACE,
        (pokemon, abilityName) =>
    ...
    new Ability(Abilities.SCREEN_CLEANER, 8).attr(
    ...
    new Ability(Abilities.STEELY_SPIRIT, 8).attr(
    ...
    new Ability(Abilities.CURIOUS_MEDICINE, 8).attr(
      PostSummonClearAllyStatStagesAbAttr,
    ),
    new Ability(Abilities.TRANSISTOR, 8).attr(
      MoveTypePowerBoostAbAttr,
      PokemonType.ELECTRIC,
      1.3,
    ),
    new Ability(Abilities.DRAGONS_MAW, 8).attr(
      MoveTypePowerBoostAbAttr,
      PokemonType.DRAGON,
    ),
    new Ability(Abilities.CHILLING_NEIGH, 8).attr(
      PostVictoryStatStageChangeAbAttr,
      Stat.ATK,
      1,
    ),
    new Ability(Abilities.GRIM_NEIGH, 8).attr(
      PostVictoryStatStageChangeAbAttr,
      Stat.SPATK,
      1,
    ),
    ...
    new Ability(Abilities.THERMAL_EXCHANGE, 9)
      .attr(
        PostDefendStatStageChangeAbAttr,
        (target, user, move) =>
          user.getMoveType(move) === PokemonType.FIRE &&
          move.category !== MoveCategory.STATUS,
        Stat.ATK,
        1,
      )
    ...
    new Ability(Abilities.WIND_RIDER, 9)
      .attr(
        ...
        (pokemon, attacker, move) =>
          pokemon !== attacker &&
          move.hasFlag(MoveFlags.WIND_MOVE) &&
          move.category !== MoveCategory.STATUS,
        Stat.ATK,
        1,
      )
    ...
    new Ability(Abilities.GUARD_DOG, 9)
      ...
      .attr(ForceSwitchOutImmunityAbAttr)
      .ignorable(),
    new Ability(Abilities.ROCKY_PAYLOAD, 9).attr(
      MoveTypePowerBoostAbAttr,
      PokemonType.ROCK,
    ),
    ...
    new Ability(Abilities.ZERO_TO_HERO, 9)
      ...
      .attr(NoFusionAbilityAbAttr)
      .attr(PostBattleInitFormChangeAbAttr, () => 0)
      .attr(PreSwitchOutFormChangeAbAttr, (pokemon) =>
        !pokemon.isFainted() ? 1 : pokemon.formIndex,
      )
      .bypassFaint(),
    ...
    new Ability(Abilities.CUD_CHEW, 9).attr(RepeatBerryNextTurnAbAttr),
    ...
    new Ability(Abilities.MYCELIUM_MIGHT, 9)
      .attr(
        ChangeMovePriorityAbAttr,
        (pokemon, move) => move.category === MoveCategory.STATUS,
        -0.2,
      )
      .attr(
    ...
    new Ability(Abilities.MINDS_EYE, 9)
      ...
      .attr(IgnoreOpponentStatStagesAbAttr, [Stat.EVA])
      .ignorable(),
    new Ability(Abilities.SUPERSWEET_SYRUP, 9).attr(
      PostSummonStatStageChangeAbAttr,
      [Stat.EVA],
      -1,
    ),
    new Ability(Abilities.HOSPITALITY, 9).attr(
      PostSummonAllyHealAbAttr,
      4,
      true,
    ),
    new Ability(Abilities.TOXIC_CHAIN, 9).attr(
