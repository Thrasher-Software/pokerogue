...
const namespace = "mysteryEncounters/malenia";
 ...
 */
export const MaleniaEncounter: MysteryEncounter = MysteryEncounterBuilder.withEncounterType(
  ...
  .withOnInit(() => {
    ...
    if (!enemyPokemon.moveset.some(m => m && m.getMove().id === Moves.WATERFOWL_DANCE)) {
      if (enemyPokemon.moveset.length < 4) {
        enemyPokemon.moveset.push(new PokemonMove(Moves.WATERFOWL_DANCE));
      } else {
        enemyPokemon.moveset[0] = new PokemonMove(Moves.WATERFOWL_DANCE);
      }
    }
    ...
    MysteryEncounterOptionBuilder.newOptionWithMode(MysteryEncounterOptionMode.DEFAULT)
      ...
      .withOptionPhase(async () => {
        ...
        encounter.startOfBattleEffects.push({
          ...
          move: new PokemonMove(Moves.WATERFOWL_DANCE),
          ignorePp: true,
        });
    ...
    MysteryEncounterOptionBuilder.newOptionWithMode(MysteryEncounterOptionMode.DEFAULT)
      ...
      .withPreOptionPhase(async () => {
        ...
        const onPokemonSelected = (pokemon: PlayerPokemon) => {
          ...
          globalScene.unshiftPhase(
            new LearnMovePhase(globalScene.getPlayerParty().indexOf(pokemon), Moves.WATERFOWL_DANCE),
          );
