...
export class SpeciesFormEvolution {
  ...
  constructor(
    ...
    if (this.item) {
      const itemDescription = i18next.t(
        `modifierType:EvolutionItem.${EvolutionItem[this.item].toUpperCase()}`,
      );
      const rarity =
        this.item > 50
          ? i18next.t("pokemonEvolutions:ULTRA")
          : i18next.t("pokemonEvolutions:GREAT");
      strings.push(
        i18next.t("pokemonEvolutions:using") + itemDescription + ` (${rarity})`,
      );
    }
    if (this.condition) {
    ...
    this.description = strings
      .filter((str) => str !== "")
      .map((str, index) =>
        index > 0 ? str[0].toLowerCase() + str.slice(1) : str,
      )
...
class GenderEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(gender: Gender) {
    ...
    this.gender = gender;
    this.description = i18next.t("pokemonEvolutions:gender", {
      gender: i18next.t(`pokemonEvolutions:${Gender[gender]}`),
    });
  }
}
...
class TimeOfDayEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(tod: "day" | "night") {
    ...
    this.description = i18next.t("pokemonEvolutions:timeOfDay", {
      tod: i18next.t(`pokemonEvolutions:${tod}`),
    });
  }
}
...
class MoveEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(move: Moves) {
    ...
    const moveKey = Moves[this.move]
      ...
      .join("");
    this.description = i18next.t("pokemonEvolutions:move", {
...
class FriendshipTimeOfDayEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(amount: number, tod: "day" | "night") {
    ...
    this.amount = amount;
    this.description = i18next.t("pokemonEvolutions:friendshipTimeOfDay", {
      tod: i18next.t(`pokemonEvolutions:${tod}`),
    });
  }
}
...
class FriendshipMoveTypeEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(amount: number, type: PokemonType) {
    ...
    this.amount = amount;
    this.type = type;
    this.description = i18next.t("pokemonEvolutions:friendshipMoveType", {
      type: i18next.t(`pokemonInfo:Type.${PokemonType[this.type]}`),
    });
  }
}
  ...
  constructor(type: PokemonType) {
    super(
      () =>
        !!globalScene
          .getPlayerParty()
          .find((p) => p.getTypes(false, false, true).indexOf(type) > -1),
    );
    this.type = type;
    this.description = i18next.t("pokemonEvolutions:partyType", {
      type: i18next.t(`pokemonInfo:Type.${PokemonType[this.type]}`),
    });
  }
}
...
class CaughtEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(species: Species) {
    ...
    this.description = i18next.t("pokemonEvolutions:caught", {
      species: i18next.t(`pokemon:${Species[this.species].toLowerCase()}`),
    });
  }
}
...
class MoveTypeEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(type: PokemonType) {
    super(
      (p) => p.moveset.filter((m) => m?.getMove().type === type).length > 0,
    );
    this.type = type;
    this.description = i18next.t("pokemonEvolutions:moveType", {
      type: i18next.t(`pokemonInfo:Type.${PokemonType[this.type]}`),
    });
  }
}
...
class TreasureEvolutionCondition extends SpeciesEvolutionCondition {
  constructor() {
    super(
      (p) =>
        p.evoCounter +
          p.getHeldItems().filter((m) => m instanceof DamageMoneyRewardModifier)
            .length +
      ...
      (p) =>
        p
          ...
          .find(
            (m) =>
              m &&
              [Moves.LOW_SWEEP, Moves.MACH_PUNCH, Moves.RAPID_SPIN].includes(
                m.moveId,
              ),
          )?.moveId === move,
    );
...
class MoveTimeOfDayEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(move: Moves, tod: "day" | "night") {
    ...
    const moveKey = Moves[this.move]
      ...
      .join("");
    this.description = i18next.t("pokemonEvolutions:moveTimeOfDay", {
      move: i18next.t(`move:${moveKey}.name`),
      tod: i18next.t(`pokemonEvolutions:${tod}`),
    });
  }
...
class BiomeEvolutionCondition extends SpeciesEvolutionCondition {
  ...
  constructor(biomes: Biome[]) {
    super(
      () => biomes.filter((b) => b === globalScene.arena.biomeType).length > 0,
    );
    this.biomes = biomes;
...
class DunsparceEvolutionCondition extends SpeciesEvolutionCondition {
  constructor() {
    ...
    const moveKey = Moves[Moves.HYPER_DRILL]
      .split("_")
      .filter((f) => f)
      .map((f, i) =>
        i ? `${f[0]}${f.slice(1).toLowerCase()}` : f.toLowerCase(),
...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [Species.CUBONE]: [
    new SpeciesEvolution(
      ...
      28,
      null,
      new TimeOfDayEvolutionCondition("night"),
    ),
    new SpeciesEvolution(
      Species.MAROWAK,
      28,
      null,
      new TimeOfDayEvolutionCondition("day"),
    ),
  ],
  [Species.TYROGUE]: [
    /**
    ...
    new SpeciesEvolution(
      ...
      20,
      null,
      new TyrogueEvolutionCondition(Moves.LOW_SWEEP),
    ),
    new SpeciesEvolution(
      Species.HITMONCHAN,
      20,
      null,
      new TyrogueEvolutionCondition(Moves.MACH_PUNCH),
    ),
    new SpeciesEvolution(
      Species.HITMONTOP,
      20,
      null,
      new TyrogueEvolutionCondition(Moves.RAPID_SPIN),
    ),
  ],
  [Species.KOFFING]: [
    new SpeciesEvolution(
  ...
  [Species.NINCADA]: [
    ...
    new SpeciesEvolution(
      ...
      20,
      null,
      new ShedinjaEvolutionCondition(),
    ),
  ],
  ...
  [Species.MANTYKE]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      new CaughtEvolutionCondition(Species.REMORAID),
  ...
  [Species.PANCHAM]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      new PartyTypeEvolutionCondition(PokemonType.DARK),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [Species.ESPURR]: [
  ...
  [Species.TANDEMAUS]: [
    new SpeciesFormEvolution(
      ...
      25,
      null,
      new TandemausEvolutionCondition(),
    ),
  ...
  [Species.TANGELA]: [
    new SpeciesEvolution(
      ...
      34,
      null,
      new MoveEvolutionCondition(Moves.ANCIENT_POWER),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.LICKITUNG]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      new MoveEvolutionCondition(Moves.ROLLOUT),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.STARYU]: [
  ...
  [Species.EEVEE]: [
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new FriendshipMoveTypeEvolutionCondition(120, PokemonType.FAIRY),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.SYLVEON,
    ...
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new FriendshipTimeOfDayEvolutionCondition(120, "day"),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.ESPEON,
    ...
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new FriendshipTimeOfDayEvolutionCondition(120, "night"),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.UMBREON,
  ...
  [Species.AIPOM]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      new MoveEvolutionCondition(Moves.DOUBLE_HIT),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.SUNKERN]: [
  ...
  [Species.GIRAFARIG]: [
    new SpeciesEvolution(
      ...
      32,
      null,
      new MoveEvolutionCondition(Moves.TWIN_BEAM),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.DUNSPARCE]: [
    new SpeciesFormEvolution(
      ...
      32,
      null,
      new DunsparceEvolutionCondition(),
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesFormEvolution(
      Species.DUDUNSPARCE,
      ...
      32,
      null,
      new MoveEvolutionCondition(Moves.HYPER_DRILL),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.GLIGAR]: [
    new SpeciesEvolution(
      ...
      new TimeOfDayEvolutionCondition("night") /* Razor fang at night*/,
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.SNEASEL]: [
    new SpeciesEvolution(
      ...
      new TimeOfDayEvolutionCondition("night") /* Razor claw at night*/,
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.URSARING]: [
  ...
  [Species.STANTLER]: [
    new SpeciesEvolution(
      ...
      25,
      null,
      new MoveEvolutionCondition(Moves.PSYSHIELD_BASH),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.LOMBRE]: [
  ...
  [Species.BONSLY]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new MoveEvolutionCondition(Moves.MIMIC),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [Species.MIME_JR]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new MoveTimeOfDayEvolutionCondition(Moves.MIMIC, "night"),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
    new SpeciesEvolution(
      Species.MR_MIME,
      1,
      null,
      new MoveTimeOfDayEvolutionCondition(Moves.MIMIC, "day"),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [Species.PANSAGE]: [
  ...
  [Species.STEENEE]: [
    new SpeciesEvolution(
      ...
      28,
      null,
      new MoveEvolutionCondition(Moves.STOMP),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.POIPOLE]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new MoveEvolutionCondition(Moves.DRAGON_PULSE),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.HISUI_QWILFISH]: [
    new SpeciesEvolution(
      ...
      28,
      null,
      new MoveEvolutionCondition(Moves.BARB_BARRAGE),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.HISUI_SNEASEL]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.RAZOR_CLAW,
      new TimeOfDayEvolutionCondition("day") /* Razor claw at day*/,
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.CHARCADET]: [
    new SpeciesEvolution(
      Species.ARMAROUGE,
      1,
      EvolutionItem.AUSPICIOUS_ARMOR,
      null,
      SpeciesWildEvolutionDelay.LONG,
    ),
    new SpeciesEvolution(
  ...
  [Species.DIPPLIN]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new MoveEvolutionCondition(Moves.DRAGON_CHEER),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.KADABRA]: [
        ...
        p
          ...
          .some(
            (m) =>
              ...
              (m.type as SpeciesStatBoosterModifierType).key ===
                "DEEP_SEA_TOOTH",
          ),
      ),
      SpeciesWildEvolutionDelay.VERY_LONG,
  ...
  [Species.KARRABLAST]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new CaughtEvolutionCondition(Species.SHELMET),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.SHELMET]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new CaughtEvolutionCondition(Species.KARRABLAST),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.SPRITZEE]: [
  ...
  [Species.PRIMEAPE]: [
    new SpeciesEvolution(
      ...
      35,
      null,
      new MoveEvolutionCondition(Moves.RAGE_FIST),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.GOLBAT]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipEvolutionCondition(120),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
  ],
  [Species.CHANSEY]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipEvolutionCondition(200),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  [Species.PICHU]: [
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new FriendshipEvolutionCondition(90),
  ...
  [Species.CLEFFA]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipEvolutionCondition(160),
      SpeciesWildEvolutionDelay.SHORT,
    ),
  ],
  [Species.IGGLYBUFF]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipEvolutionCondition(70),
      SpeciesWildEvolutionDelay.SHORT,
    ),
  ],
  [Species.TOGEPI]: [
  ...
  [Species.BUDEW]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipTimeOfDayEvolutionCondition(70, "day"),
      SpeciesWildEvolutionDelay.SHORT,
    ),
  ],
  [Species.BUNEARY]: [
  ...
  [Species.CHINGLING]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipTimeOfDayEvolutionCondition(90, "night"),
      SpeciesWildEvolutionDelay.MEDIUM,
    ),
  ],
  [Species.HAPPINY]: [
  ...
  [Species.TYPE_NULL]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new FriendshipEvolutionCondition(100),
      SpeciesWildEvolutionDelay.LONG,
    ),
  ],
  ...
  [Species.GIMMIGHOUL]: [
    new SpeciesFormEvolution(
      ...
      1,
      null,
      new TreasureEvolutionCondition(),
      SpeciesWildEvolutionDelay.VERY_LONG,
    ),
    new SpeciesFormEvolution(
      Species.GHOLDENGO,
