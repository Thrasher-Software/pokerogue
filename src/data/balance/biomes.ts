...
export const biomePokemonPools: BiomePokemonPools = {
  [Biome.TOWN]: {
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.DUSK]: [Species.DELTA_LOTAD],
      [TimeOfDay.NIGHT]: [Species.DELTA_LOTAD],
      [TimeOfDay.ALL]: [
        Species.ABRA,
        Species.SURSKIT,
        Species.ROOKIDEE,
    ...
    [BiomePoolTier.UNCOMMON]: {
      [TimeOfDay.DAWN]: [
        ...
        { 1: [Species.POOCHYENA], 18: [Species.MIGHTYENA] },
        {
          1: [Species.STARLY],
          14: [Species.STARAVIA],
          34: [Species.STARAPTOR],
        },
        {
          1: [Species.PIDOVE],
          21: [Species.TRANQUILL],
          32: [Species.UNFEZANT],
        },
      ...
      [TimeOfDay.ALL]: [
        ...
        Species.PIKACHU,
        {
          1: [Species.FLETCHLING],
          17: [Species.FLETCHINDER],
          35: [Species.TALONFLAME],
        },
      ],
    },
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.ROOKIDEE],
          18: [Species.CORVISQUIRE],
          38: [Species.CORVIKNIGHT],
        },
      ],
    },
    [BiomePoolTier.SUPER_RARE]: {
  ...
  [Biome.FOREST]: {
    [BiomePoolTier.COMMON]: {
      ...
      [TimeOfDay.DUSK]: [
        ...
        {
          1: [Species.VENIPEDE],
          22: [Species.WHIRLIPEDE],
          30: [Species.SCOLIPEDE],
        },
      ],
      [TimeOfDay.NIGHT]: [
        Species.BEEDRILL,
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.CHESPIN],
          16: [Species.QUILLADIN],
          36: [Species.CHESNAUGHT],
        },
  ...
  [Biome.SWAMP]: {
    [BiomePoolTier.COMMON]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.TYMPOLE],
          25: [Species.PALPITOAD],
          36: [Species.SEISMITOAD],
        },
      ],
    },
    [BiomePoolTier.UNCOMMON]: {
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.DAY]: [],
      [TimeOfDay.DUSK]: [
        { 1: [Species.DELTA_LOTAD], 14: [Species.DELTA_LOMBRE] },
      ],
      [TimeOfDay.NIGHT]: [
        { 1: [Species.DELTA_LOTAD], 14: [Species.DELTA_LOMBRE] },
      ],
      [TimeOfDay.ALL]: [
        {
          1: [Species.TOTODILE],
          18: [Species.CROCONAW],
          30: [Species.FERALIGATR],
        },
        {
          1: [Species.MUDKIP],
          16: [Species.MARSHTOMP],
          36: [Species.SWAMPERT],
        },
      ],
    },
  ...
  [Biome.LAKE]: {
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.ALL]: [
        {
          1: [Species.SQUIRTLE],
          16: [Species.WARTORTLE],
          36: [Species.BLASTOISE],
        },
        { 1: [Species.OSHAWOTT], 17: [Species.DEWOTT], 36: [Species.SAMUROTT] },
        {
          1: [Species.FROAKIE],
          16: [Species.FROGADIER],
          36: [Species.GRENINJA],
        },
  ...
  [Biome.MOUNTAIN]: {
    ...
    [BiomePoolTier.UNCOMMON]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.NACLI],
          24: [Species.NACLSTACK],
          38: [Species.GARGANACL],
        },
      ],
    },
    [BiomePoolTier.RARE]: {
  ...
  [Biome.ICE_CAVE]: {
    [BiomePoolTier.COMMON]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.VANILLITE],
          35: [Species.VANILLISH],
          47: [Species.VANILLUXE],
        },
    ...
    [BiomePoolTier.SUPER_RARE]: {
      ...
      [TimeOfDay.ALL]: [
        Species.DELIBIRD,
        Species.ROTOM,
        { 1: [Species.AMAURA], 59: [Species.AURORUS] },
      ],
    },
    [BiomePoolTier.ULTRA_RARE]: {
      [TimeOfDay.DAWN]: [],
  ...
  [Biome.MEADOW]: {
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.SPRIGATITO],
          16: [Species.FLORAGATO],
          36: [Species.MEOWSCARADA],
        },
      ],
    },
    [BiomePoolTier.SUPER_RARE]: {
      ...
      [TimeOfDay.ALL]: [
        {
          ...
          16: [Species.CHARMELEON],
          36: [Species.CHARIZARD],
        },
        {
          1: [Species.CYNDAQUIL],
          14: [Species.QUILAVA],
          36: [Species.TYPHLOSION],
        },
        {
          1: [Species.CHIMCHAR],
          14: [Species.MONFERNO],
          36: [Species.INFERNAPE],
        },
        ...
        { 1: [Species.FENNEKIN], 16: [Species.BRAIXEN], 36: [Species.DELPHOX] },
        {
          1: [Species.LITTEN],
          17: [Species.TORRACAT],
          34: [Species.INCINEROAR],
        },
        {
          1: [Species.SCORBUNNY],
          16: [Species.RABOOT],
          35: [Species.CINDERACE],
        },
  ...
  [Biome.RUINS]: {
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.GOTHITA],
          32: [Species.GOTHORITA],
          41: [Species.GOTHITELLE],
        },
        Species.STONJOURNER,
        Species.ARTORIAS,
      ],
    ...
    [BiomePoolTier.SUPER_RARE]: {
      ...
      [TimeOfDay.DUSK]: [
        { 1: [Species.GALAR_YAMASK], 34: [Species.RUNERIGUS] },
      ],
      [TimeOfDay.NIGHT]: [
        { 1: [Species.GALAR_YAMASK], 34: [Species.RUNERIGUS] },
      ],
    ...
    [BiomePoolTier.BOSS_RARE]: {
      [TimeOfDay.DAWN]: [],
      [TimeOfDay.DAY]: [Species.ESPEON],
      [TimeOfDay.DUSK]: [Species.RUNERIGUS, Species.DELTA_LUDICOLO],
      [TimeOfDay.NIGHT]: [Species.RUNERIGUS, Species.DELTA_LUDICOLO],
  ...
  [Biome.WASTELAND]: {
    ...
    [BiomePoolTier.RARE]: {
      ...
      [TimeOfDay.ALL]: [
        {
          1: [Species.DRATINI],
          30: [Species.DRAGONAIR],
          55: [Species.DRAGONITE],
        },
        {
          1: [Species.FRIGIBAX],
          35: [Species.ARCTIBAX],
    ...
    [BiomePoolTier.COMMON]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        { 1: [Species.PURRLOIN], 20: [Species.LIEPARD] },
        {
          1: [Species.PAWNIARD],
          52: [Species.BISHARP],
          64: [Species.KINGAMBIT],
        },
        { 1: [Species.NICKIT], 18: [Species.THIEVUL] },
        {
          1: [Species.IMPIDIMP],
          32: [Species.MORGREM],
          42: [Species.GRIMMSNARL],
        },
  ...
  [Biome.SPACE]: {
    ...
    [BiomePoolTier.ULTRA_RARE]: {
      ...
      [TimeOfDay.NIGHT]: [],
      [TimeOfDay.ALL]: [
        { 1: [Species.COSMOG], 43: [Species.COSMOEM] },
        Species.CELESTEELA,
      ],
    },
    [BiomePoolTier.BOSS]: {
  ...
  [Biome.SNOWY_FOREST]: {
    ...
    [BiomePoolTier.SUPER_RARE]: {
      ...
      [TimeOfDay.DUSK]: [
        { 1: [Species.HISUI_ZORUA], 30: [Species.HISUI_ZOROARK] },
      ],
      [TimeOfDay.NIGHT]: [
        { 1: [Species.HISUI_ZORUA], 30: [Species.HISUI_ZOROARK] },
      ],
  ...
  [Biome.ISLAND]: {
    [BiomePoolTier.COMMON]: {
      ...
      [TimeOfDay.ALL]: [
        ...
        {
          1: [Species.ALOLA_GEODUDE],
          25: [Species.ALOLA_GRAVELER],
          40: [Species.ALOLA_GOLEM],
        },
...
export function initBiomes() {
  const pokemonBiomes = [
    ...
    [
      ...
      [
        ...
        [
          Biome.GRAVEYARD,
          BiomePoolTier.BOSS,
          [TimeOfDay.DAWN, TimeOfDay.DAY, TimeOfDay.DUSK],
        ],
      ],
    ],
    [
    ...
    [Species.PIPLUP, PokemonType.WATER, -1, [[Biome.SEA, BiomePoolTier.RARE]]],
    [
      Species.PRINPLUP,
      PokemonType.WATER,
      -1,
    ...
    [Species.DEWOTT, PokemonType.WATER, -1, [[Biome.LAKE, BiomePoolTier.RARE]]],
    [
      Species.SAMUROTT,
      PokemonType.WATER,
      -1,
    ...
    [Species.ZORUA, PokemonType.DARK, -1, [[Biome.ABYSS, BiomePoolTier.RARE]]],
    [
      Species.ZOROARK,
      PokemonType.DARK,
      -1,
    ...
    [Species.POPPLIO, PokemonType.WATER, -1, [[Biome.SEA, BiomePoolTier.RARE]]],
    [Species.BRIONNE, PokemonType.WATER, -1, [[Biome.SEA, BiomePoolTier.RARE]]],
    [
      Species.PRIMARINA,
      PokemonType.WATER,
      PokemonType.FAIRY,
    ...
    [Species.SOBBLE, PokemonType.WATER, -1, [[Biome.LAKE, BiomePoolTier.RARE]]],
    [
      Species.DRIZZILE,
      PokemonType.WATER,
      -1,
    ...
    [Species.RJ, PokemonType.NORMAL, -1, [[Biome.TOWN, BiomePoolTier.COMMON]]],
    [
      Species.SHOOKY,
      PokemonType.DARK,
      PokemonType.FAIRY,
    ...
    [
      ...
      [
        ...
        [Biome.LAKE, BiomePoolTier.RARE, [TimeOfDay.DUSK, TimeOfDay.NIGHT]],
        [Biome.SWAMP, BiomePoolTier.RARE, [TimeOfDay.DUSK, TimeOfDay.NIGHT]],
      ],
    ],
    [
    ...
    [Species.DELTA_KARRABLAST, PokemonType.FAIRY, -1, []],
    [Species.DELTA_ESCAVALIER, PokemonType.FAIRY, -1, []],
  ...
  const trainerBiomes = [
    ...
    [TrainerType.HOOLIGANS, [[Biome.SLUM, BiomePoolTier.UNCOMMON]]],
    [TrainerType.HOOPSTER, []],
    [TrainerType.INFIELDER, []],
    [TrainerType.JANITOR, []],
    [TrainerType.LINEBACKER, []],
    [TrainerType.MAID, []],
    [TrainerType.MUSICIAN, [[Biome.MEADOW, BiomePoolTier.COMMON]]],
    [
      TrainerType.HEX_MANIAC,
      [
        [Biome.RUINS, BiomePoolTier.UNCOMMON],
    ...
    [TrainerType.PILOT, [[Biome.MOUNTAIN, BiomePoolTier.UNCOMMON]]],
    [
      TrainerType.POKEFAN,
      [
        [Biome.GRASS, BiomePoolTier.UNCOMMON],
    ...
    [TrainerType.RICH, [[Biome.ISLAND, BiomePoolTier.UNCOMMON]]],
    [
  ...
  const traverseBiome = (biome: Biome, depth: number) => {
    if (biome === Biome.END) {
      const biomeList = Object.keys(Biome).filter(
    ...
    const linkedBiomes: (Biome | [Biome, number])[] = Array.isArray(
      biomeLinks[biome],
    )
    ...
    for (const linkedBiomeEntry of linkedBiomes) {
      ...
      if (
        ...
        (depth < biomeDepths[linkedBiome][0] &&
          biomeChance === biomeDepths[linkedBiome][1])
      ) {
  ...
  for (const pb of pokemonBiomes) {
    ...
    const speciesEvolutions: SpeciesFormEvolution[] =
      pokemonEvolutions.hasOwnProperty(speciesId)
    ...
    if (
      ...
      !speciesEvolutions.filter(
        (es) =>
          !!(
            pokemonBiomes.find((p) => p[0] === es.speciesId)![3] as any[]
          ).filter((b) => b[0] !== Biome.END).length,
      ).length
    ) {
    ...
    for (const b of biomeEntries) {
      ...
      const tier = b[1];
      const timesOfDay =
        b.length > 2 ? (Array.isArray(b[2]) ? b[2] : [b[2]]) : [TimeOfDay.ALL];
      ...
      for (const tod of timesOfDay) {
        ...
        for (let t = 0; t < biomeTierPool.length; t++) {
          ...
          for (let es = 0; es < existingSpeciesIds.length; es++) {
            ...
            if (
              ...
              (
                pokemonEvolutions[existingSpeciesId] as SpeciesFormEvolution[]
            ...
            if (
              speciesEvolutions?.find(
                (se) => se.speciesId === existingSpeciesId,
              )
            ) {
              treeIndex = t;
              arrayIndex = es;
        ...
        if (treeIndex > -1) {
          (biomeTierPool[treeIndex] as unknown as Species[]).splice(
            arrayIndex,
            0,
            speciesId,
          );
          ...
          if (entry.length === 1) {
            ...
            for (let s = 1; s < entry.length; s++) {
              ...
              const prevolution = entry
                .flatMap((s: string | number) => pokemonEvolutions[s])
  ...
  for (const tb of trainerBiomes) {
    ...
    for (const b of biomeEntries) {
      ...
      if (
        !biomeTrainerPools.hasOwnProperty(biome) ||
        !biomeTrainerPools[biome].hasOwnProperty(tier)
      ) {
        continue;
      }
