...
export const speciesEggTiers = {
  ...
  [Species.VAN]: EggTier.LEGENDARY,
  [Species.KOYA]: EggTier.RARE,
  [Species.HARDEVIL]: EggTier.RARE,
  [Species.RJ]: EggTier.RARE,
  [Species.SHOOKY]: EggTier.RARE,
  [Species.MANG]: EggTier.RARE,
  [Species.COOKY]: EggTier.RARE,
  [Species.TATA]: EggTier.RARE,
  [Species.CHIMMY]: EggTier.RARE,
  [Species.FOALIT]: EggTier.COMMON,
  [Species.DELTA_BULBASAUR]: EggTier.RARE,
  [Species.DELTA_CHARMANDER]: EggTier.RARE,
  [Species.DELTA_SQUIRTLE]: EggTier.RARE,
  [Species.DELTA_PIDGEY]: EggTier.RARE,
  [Species.DELTA_GROWLITHE]: EggTier.RARE,
  [Species.DELTA_GEODUDE]: EggTier.RARE,
  [Species.DELTA_DODUO]: EggTier.RARE,
  [Species.DELTA_KOFFING]: EggTier.RARE,
  [Species.DELTA_SCYTHER]: EggTier.RARE,
  [Species.DELTA_LOTAD]: EggTier.RARE,
  [Species.DELTA_RALTS]: EggTier.RARE,
  [Species.DELTA_ARON]: EggTier.RARE,
  [Species.DELTA_REGIROCK]: EggTier.EPIC,
  [Species.DELTA_REGICE]: EggTier.EPIC,
  [Species.DELTA_REGISTEEL]: EggTier.EPIC,
  [Species.DELTA_COMBEE]: EggTier.RARE,
  [Species.DELTA_PURRLOIN]: EggTier.RARE,
  [Species.DELTA_PAWNIARD]: EggTier.RARE,
  [Species.DELTA_PHANTUMP]: EggTier.RARE,
